...
include ($_SERVER['DOCUMENT_ROOT']."/ecc/photos//galleryinfo.php");
  ...
  $pgtitle = "Sleeping";
  $entryid = 486;
  $img = '<img alt="Sleeping" src="http://www.whatisnext.co.uk/ecc/photos/assets/2005-08-15-14-19-16.jpg" width="640" height="480" />';
...
<div id="Wrapper" class="Relative">
	...
	<div id="Document">
		...
		<div id="DocumentContent">
			...
			<p id="GalleryPath"><a href="<?= $blogrelurl ?>">E.C.C Tours of Duty</a> > <a href="<?= $galleryurl ?>"><?= $gallerytitle ?></a> > <a href="<?= $galleryurl ?>gallery/">Gallery</a> > Sleeping</p>  
			
			<div id="Photo"><img alt="Sleeping" src="http://www.whatisnext.co.uk/ecc/photos/assets/2005-08-15-14-19-16.jpg" width="640" height="480" /></div>
			
			<div id="PhotoInfo">
				<h1>E.C.C Tours of Duty</h1>
				<p>This was ont he way down there. I think he wasn&#8217;t expecting to get much sleep in cornwall</p>
			</div>
			<div id="PhotoMeta">
				<ul>
					<li class="count">Photo # of #</li>
					<li class="date">15 August 2005</li>
