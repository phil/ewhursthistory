...
include ($_SERVER['DOCUMENT_ROOT']."/ecc/photos//galleryinfo.php");
  ...
  $pgtitle = "Alex";
  $entryid = 489;
  $img = '<img alt="Alex" src="http://www.whatisnext.co.uk/ecc/photos/assets/2005-08-15-20-09-48.jpg" width="640" height="480" />';
...
<div id="Wrapper" class="Relative">
	...
	<div id="Document">
		...
		<div id="DocumentContent">
			...
			<p id="GalleryPath"><a href="<?= $blogrelurl ?>">E.C.C Tours of Duty</a> > <a href="<?= $galleryurl ?>"><?= $gallerytitle ?></a> > <a href="<?= $galleryurl ?>gallery/">Gallery</a> > Alex</p>  
			
			<div id="Photo"><img alt="Alex" src="http://www.whatisnext.co.uk/ecc/photos/assets/2005-08-15-20-09-48.jpg" width="640" height="480" /></div>
