<?php
  ...
  $section = "photosolo";
  $pgtitle = "Creedy, tries to think of something clever to say";
  $entryid = 299;
  $img = '<img alt="Creedy, tries to think of something clever to say" src="http://www.whatisnext.co.uk/ecc/photosassets/2004-08-13-02-03-38.jpg" width="640" height="480" />';
  $opencomments = true;
...
<div id="desc">
  <h1>Creedy, tries to think of something clever to say</h1>
...
<form method="post" action="http://www.whatisnext.co.uk/cgi-bin/mt/mt-comments.cgi" onsubmit="if (this.bakecookie[0].checked) rememberMe(this)" id="comments-form">
  ...
  <tr valign="top" align="left">
    ...
    <input type="hidden" name="entry_id" value="299" /></td>
  </tr>
...
<p id="path"><a href="<?= $blogrelurl ?>">E.C.C Tours of Duty</a> > <a href="<?= $galleryurl ?>"><?= $gallerytitle ?></a> > <a href="<?= $galleryurl ?>gallery/">Gallery</a> > Creedy, tries to think of something clever to say</p>
