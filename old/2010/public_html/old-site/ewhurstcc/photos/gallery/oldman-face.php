...
include ($_SERVER['DOCUMENT_ROOT']."/ecc/photos//galleryinfo.php");
  ...
  $section = "photosolo";
  $pgtitle = "Old-man Face";
  $entryid = 474;
  $img = '<img alt="Old-man Face" src="http://www.whatisnext.co.uk/ecc/photos/assets/2004-08-13-01-35-44.jpg" width="640" height="480" />';
...
<div id="Wrapper" class="Relative">
	...
	<div id="Document">
		...
		<div id="DocumentContent">
			...
			<p id="GalleryPath"><a href="<?= $blogrelurl ?>">E.C.C Tours of Duty</a> > <a href="<?= $galleryurl ?>"><?= $gallerytitle ?></a> > <a href="<?= $galleryurl ?>gallery/">Gallery</a> > Old-man Face</p>  
			
			<div id="Photo"><img alt="Old-man Face" src="http://www.whatisnext.co.uk/ecc/photos/assets/2004-08-13-01-35-44.jpg" width="640" height="480" /></div>
