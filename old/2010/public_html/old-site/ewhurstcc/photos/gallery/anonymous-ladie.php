<?php
  ...
  $section = "photosolo";
  $pgtitle = "Anonymous Ladie";
  $entryid = 313;
  $img = '<img alt="Anonymous Ladie" src="http://www.whatisnext.co.uk/ecc/photosassets/2004-08-13-02-40-51.jpg" width="480" height="640" />';
  $opencomments = true;
...
<form method="post" action="http://www.whatisnext.co.uk/cgi-bin/mt/mt-comments.cgi" onsubmit="if (this.bakecookie[0].checked) rememberMe(this)" id="comments-form">
  ...
  <tr valign="top" align="left">
    ...
    <input type="hidden" name="entry_id" value="313" /></td>
  </tr>
...
<p id="path"><a href="<?= $blogrelurl ?>">E.C.C Tours of Duty</a> > <a href="<?= $galleryurl ?>"><?= $gallerytitle ?></a> > <a href="<?= $galleryurl ?>gallery/">Gallery</a> > Anonymous Ladie</p>
