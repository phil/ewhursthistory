...
include ($_SERVER['DOCUMENT_ROOT']."/ecc/photos//galleryinfo.php");
  ...
  $pgtitle = "IMG_0328";
  $entryid = 439;
  $img = '<img alt="IMG_0328" src="http://www.whatisnext.co.uk/ecc/photos/assets/2003-09-28-03-59-04.jpg" width="640" height="480" />';
...
<div id="Wrapper" class="Relative">
	...
	<div id="Document">
		...
		<div id="DocumentContent">
			...
			<p id="GalleryPath"><a href="<?= $blogrelurl ?>">E.C.C Tours of Duty</a> > <a href="<?= $galleryurl ?>"><?= $gallerytitle ?></a> > <a href="<?= $galleryurl ?>gallery/">Gallery</a> > IMG_0328</p>  
			
			<div id="Photo"><img alt="IMG_0328" src="http://www.whatisnext.co.uk/ecc/photos/assets/2003-09-28-03-59-04.jpg" width="640" height="480" /></div>
