<?php
  ...
  $section = "photosolo";
  $pgtitle = "Darryl and Gav have finished, James hasn&#8217;t started yet";
  $entryid = 374;
  $img = '<img alt="Darryl and Gav have finished, James hasn\'t started yet" src="http://www.whatisnext.co.uk/ecc/photosassets/2005-08-18-02-51-06.jpg" width="640" height="480" />';
  $opencomments = true;
...
<div id="desc">
  <h1>Darryl and Gav have finished, James hasn&#8217;t started yet</h1>
...
<div id="main">
  ...
  <div id="meta">
    <ul>
      ...
      <li class="date">18 August 2005</li>
...
<form method="post" action="http://www.whatisnext.co.uk/cgi-bin/mt/mt-comments.cgi" onsubmit="if (this.bakecookie[0].checked) rememberMe(this)" id="comments-form">
  ...
  <tr valign="top" align="left">
    ...
    <input type="hidden" name="entry_id" value="374" /></td>
  </tr>
...
<p id="path"><a href="<?= $blogrelurl ?>">E.C.C Tours of Duty</a> > <a href="<?= $galleryurl ?>"><?= $gallerytitle ?></a> > <a href="<?= $galleryurl ?>gallery/">Gallery</a> > Darryl and Gav have finished, James hasn&#8217;t started yet</p>
