<?php
  ...
  $section = "photosolo";
  $pgtitle = "Gibbo and someone he&#8217;d rather forget";
  $entryid = 287;
  $img = '<img alt="Gibbo and someone he\'d rather forget" src="http://www.whatisnext.co.uk/ecc/photosassets/2004-08-13-01-33-20.jpg" width="640" height="480" />';
  $opencomments = true;
...
<div id="desc">
  <h1>Gibbo and someone he&#8217;d rather forget</h1>
  <p>Next year it will be Orrys turn</p>
</div>
...
<form method="post" action="http://www.whatisnext.co.uk/cgi-bin/mt/mt-comments.cgi" onsubmit="if (this.bakecookie[0].checked) rememberMe(this)" id="comments-form">
  ...
  <tr valign="top" align="left">
    ...
    <input type="hidden" name="entry_id" value="287" /></td>
  </tr>
...
<p id="path"><a href="<?= $blogrelurl ?>">E.C.C Tours of Duty</a> > <a href="<?= $galleryurl ?>"><?= $gallerytitle ?></a> > <a href="<?= $galleryurl ?>gallery/">Gallery</a> > Gibbo and someone he&#8217;d rather forget</p>
