...
include ($_SERVER['DOCUMENT_ROOT']."/ecc/photos//galleryinfo.php");
  ...
  $pgtitle = "Sandwich";
  $entryid = 416;
  $img = '<img alt="Sandwich" src="http://www.whatisnext.co.uk/ecc/photos/assets/2003-09-28-00-03-31.jpg" width="640" height="480" />';
...
<div id="Wrapper" class="Relative">
	...
	<div id="Document">
		...
		<div id="DocumentContent">
			...
			<p id="GalleryPath"><a href="<?= $blogrelurl ?>">E.C.C Tours of Duty</a> > <a href="<?= $galleryurl ?>"><?= $gallerytitle ?></a> > <a href="<?= $galleryurl ?>gallery/">Gallery</a> > Sandwich</p>  
			
			<div id="Photo"><img alt="Sandwich" src="http://www.whatisnext.co.uk/ecc/photos/assets/2003-09-28-00-03-31.jpg" width="640" height="480" /></div>
