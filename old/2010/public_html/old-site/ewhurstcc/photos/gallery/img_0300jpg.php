...
include ($_SERVER['DOCUMENT_ROOT']."/ecc/photos//galleryinfo.php");
  ...
  $section = "photosolo";
  $pgtitle = "IMG_0300.JPG";
  $entryid = 424;
  $img = '<img alt="IMG_0300.JPG" src="http://www.whatisnext.co.uk/ecc/photos/assets/2003-09-28-01-04-21.jpg" width="640" height="480" />';
...
<div id="Wrapper" class="Relative">
	...
	<div id="Document">
		...
		<div id="DocumentContent">
			...
			<p id="GalleryPath"><a href="<?= $blogrelurl ?>">E.C.C Tours of Duty</a> > <a href="<?= $galleryurl ?>"><?= $gallerytitle ?></a> > <a href="<?= $galleryurl ?>gallery/">Gallery</a> > IMG_0300.JPG</p>  
			
			<div id="Photo"><img alt="IMG_0300.JPG" src="http://www.whatisnext.co.uk/ecc/photos/assets/2003-09-28-01-04-21.jpg" width="640" height="480" /></div>
