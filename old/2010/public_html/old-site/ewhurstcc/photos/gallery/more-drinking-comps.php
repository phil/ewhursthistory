<?php
  ...
  $section = "photosolo";
  $pgtitle = "More Drinking Comps";
  $entryid = 395;
  $img = '<img alt="More Drinking Comps" src="http://www.whatisnext.co.uk/ecc/photosassets/2005-08-18-23-06-25.jpg" width="640" height="480" />';
  $opencomments = true;
...
<div id="desc">
  <h1>More Drinking Comps</h1>
  <p>It was close, but darryl, won</p>
</div>
...
<form method="post" action="http://www.whatisnext.co.uk/cgi-bin/mt/mt-comments.cgi" onsubmit="if (this.bakecookie[0].checked) rememberMe(this)" id="comments-form">
  ...
  <tr valign="top" align="left">
    ...
    <input type="hidden" name="entry_id" value="395" /></td>
  </tr>
...
<p id="path"><a href="<?= $blogrelurl ?>">E.C.C Tours of Duty</a> > <a href="<?= $galleryurl ?>"><?= $gallerytitle ?></a> > <a href="<?= $galleryurl ?>gallery/">Gallery</a> > More Drinking Comps</p>
