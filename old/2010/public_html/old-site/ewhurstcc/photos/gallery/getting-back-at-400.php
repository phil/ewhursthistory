<?php
  ...
  $section = "photosolo";
  $pgtitle = "Getting back at 4:00";
  $entryid = 316;
  $img = '<img alt="Getting back at 4:00" src="http://www.whatisnext.co.uk/ecc/photosassets/2004-08-13-03-19-26.jpg" width="640" height="480" />';
  $opencomments = true;
...
<div id="desc">
  <h1>Getting back at 4:00</h1>
  <p>Notice Johnny is oprting a souvenir of Holland.</p>
</div>
...
<form method="post" action="http://www.whatisnext.co.uk/cgi-bin/mt/mt-comments.cgi" onsubmit="if (this.bakecookie[0].checked) rememberMe(this)" id="comments-form">
  ...
  <tr valign="top" align="left">
    ...
    <input type="hidden" name="entry_id" value="316" /></td>
  </tr>
...
<p id="path"><a href="<?= $blogrelurl ?>">E.C.C Tours of Duty</a> > <a href="<?= $galleryurl ?>"><?= $gallerytitle ?></a> > <a href="<?= $galleryurl ?>gallery/">Gallery</a> > Getting back at 4:00</p>
