<?php
  ...
  $pgtitle = "Nice Idea?";
  $entryid = 326;
  $img = '<img alt="Nice Idea?" src="http://www.whatisnext.co.uk/ecc/photosassets/2005-08-16-19-29-22.jpg" width="480" height="640" />';
  $opencomments = true;
...
<form method="post" action="http://www.whatisnext.co.uk/cgi-bin/mt/mt-comments.cgi" onsubmit="if (this.bakecookie[0].checked) rememberMe(this)" id="comments-form">
  ...
  <tr valign="top" align="left">
    ...
    <input type="hidden" name="entry_id" value="326" /></td>
  </tr>
...
<p id="path"><a href="<?= $blogrelurl ?>">E.C.C Tours of Duty</a> > <a href="<?= $galleryurl ?>"><?= $gallerytitle ?></a> > <a href="<?= $galleryurl ?>gallery/">Gallery</a> > Nice Idea?</p>
