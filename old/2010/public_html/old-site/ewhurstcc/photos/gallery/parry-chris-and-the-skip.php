<?php
  ...
  $section = "photosolo";
  $pgtitle = "Parry, Chris and the skip";
  $entryid = 371;
  $img = '<img alt="Parry, Chris and the skip" src="http://www.whatisnext.co.uk/ecc/photosassets/2005-08-18-02-44-10.jpg" width="480" height="640" />';
  $opencomments = true;
...
<div id="desc">
  <h1>Parry, Chris and the skip</h1>
...
<form method="post" action="http://www.whatisnext.co.uk/cgi-bin/mt/mt-comments.cgi" onsubmit="if (this.bakecookie[0].checked) rememberMe(this)" id="comments-form">
  ...
  <tr valign="top" align="left">
    ...
    <input type="hidden" name="entry_id" value="371" /></td>
  </tr>
...
<p id="path"><a href="<?= $blogrelurl ?>">E.C.C Tours of Duty</a> > <a href="<?= $galleryurl ?>"><?= $gallerytitle ?></a> > <a href="<?= $galleryurl ?>gallery/">Gallery</a> > Parry, Chris and the skip</p>
