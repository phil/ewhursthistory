...
include ($_SERVER['DOCUMENT_ROOT']."/ecc/photos//galleryinfo.php");
  ...
  $pgtitle = "Ahhaaaaaa!";
  $entryid = 449;
  $img = '<img alt="Ahhaaaaaa!" src="http://www.whatisnext.co.uk/ecc/photos/assets/2003-09-29-03-06-15.jpg" width="640" height="480" />';
...
<div id="Wrapper" class="Relative">
	...
	<div id="Document">
		...
		<div id="DocumentContent">
			...
			<p id="GalleryPath"><a href="<?= $blogrelurl ?>">E.C.C Tours of Duty</a> > <a href="<?= $galleryurl ?>"><?= $gallerytitle ?></a> > <a href="<?= $galleryurl ?>gallery/">Gallery</a> > Ahhaaaaaa!</p>  
			
			<div id="Photo"><img alt="Ahhaaaaaa!" src="http://www.whatisnext.co.uk/ecc/photos/assets/2003-09-29-03-06-15.jpg" width="640" height="480" /></div>
