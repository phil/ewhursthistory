...
include ($_SERVER['DOCUMENT_ROOT']."/ecc/photos//galleryinfo.php");
  ...
  $section = "photosolo";
  $pgtitle = "PIC00029.jpg";
  $entryid = 470;
  $img = '<img alt="PIC00029.jpg" src="http://www.whatisnext.co.uk/ecc/photos/assets/2004-08-12-22-35-08.jpg" width="640" height="480" />';
...
<div id="Wrapper" class="Relative">
	...
	<div id="Document">
		...
		<div id="DocumentContent">
			...
			<p id="GalleryPath"><a href="<?= $blogrelurl ?>">E.C.C Tours of Duty</a> > <a href="<?= $galleryurl ?>"><?= $gallerytitle ?></a> > <a href="<?= $galleryurl ?>gallery/">Gallery</a> > PIC00029.jpg</p>  
			
			<div id="Photo"><img alt="PIC00029.jpg" src="http://www.whatisnext.co.uk/ecc/photos/assets/2004-08-12-22-35-08.jpg" width="640" height="480" /></div>
