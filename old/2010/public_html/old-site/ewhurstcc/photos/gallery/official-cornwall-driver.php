...
include ($_SERVER['DOCUMENT_ROOT']."/ecc/photos//galleryinfo.php");
  ...
  $section = "photosolo";
  $pgtitle = "Official Cornwall Driver";
  $entryid = 482;
  $img = '<img alt="Official Cornwall Driver" src="http://www.whatisnext.co.uk/ecc/photos/assets/2005-08-15-10-26-48.jpg" width="640" height="480" />';
...
<div id="Wrapper" class="Relative">
	...
	<div id="Document">
		...
		<div id="DocumentContent">
			...
			<p id="GalleryPath"><a href="<?= $blogrelurl ?>">E.C.C Tours of Duty</a> > <a href="<?= $galleryurl ?>"><?= $gallerytitle ?></a> > <a href="<?= $galleryurl ?>gallery/">Gallery</a> > Official Cornwall Driver</p>  
			
			<div id="Photo"><img alt="Official Cornwall Driver" src="http://www.whatisnext.co.uk/ecc/photos/assets/2005-08-15-10-26-48.jpg" width="640" height="480" /></div>
