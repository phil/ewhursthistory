...
include ($_SERVER['DOCUMENT_ROOT']."/ecc/photos//galleryinfo.php");
  ...
  $pgtitle = "New undies";
  $entryid = 536;
  $img = '<img alt="New undies" src="http://www.whatisnext.co.uk/ecc/photos/assets/2005-08-19-00-21-39.jpg" width="640" height="480" />';
...
<div id="Wrapper" class="Relative">
	...
	<div id="Document">
		...
		<div id="DocumentContent">
			...
			<p id="GalleryPath"><a href="<?= $blogrelurl ?>">E.C.C Tours of Duty</a> > <a href="<?= $galleryurl ?>"><?= $gallerytitle ?></a> > <a href="<?= $galleryurl ?>gallery/">Gallery</a> > New undies</p>  
			
			<div id="Photo"><img alt="New undies" src="http://www.whatisnext.co.uk/ecc/photos/assets/2005-08-19-00-21-39.jpg" width="640" height="480" /></div>
