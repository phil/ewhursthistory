<?php
  ...
  $section = "photosolo";
  $pgtitle = "Lick this bitch!";
  $entryid = 377;
  $img = '<img alt="Lick this bitch!" src="http://www.whatisnext.co.uk/ecc/photosassets/2005-08-18-02-56-23.jpg" width="640" height="480" />';
  $opencomments = true;
...
<div id="desc">
  <h1>Lick this bitch!</h1>
  <p>Whats really happending, is, Parry has spilt a bit of bear on Chris</p>
</div>
...
<form method="post" action="http://www.whatisnext.co.uk/cgi-bin/mt/mt-comments.cgi" onsubmit="if (this.bakecookie[0].checked) rememberMe(this)" id="comments-form">
  ...
  <tr valign="top" align="left">
    ...
    <input type="hidden" name="entry_id" value="377" /></td>
  </tr>
...
<p id="path"><a href="<?= $blogrelurl ?>">E.C.C Tours of Duty</a> > <a href="<?= $galleryurl ?>"><?= $gallerytitle ?></a> > <a href="<?= $galleryurl ?>gallery/">Gallery</a> > Lick this bitch!</p>
