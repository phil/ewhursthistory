<?php
  ...
  $pgtitle = "Robby";
  $entryid = 376;
  $img = '<img alt="Robby" src="http://www.whatisnext.co.uk/ecc/photosassets/2005-08-18-02-55-34.jpg" width="640" height="480" />';
  $opencomments = true;
...
<div id="desc">
  <h1>Robby</h1>
  <p>Parry just can&#8217;t help himself, robby, again.</p>
</div>
...
<form method="post" action="http://www.whatisnext.co.uk/cgi-bin/mt/mt-comments.cgi" onsubmit="if (this.bakecookie[0].checked) rememberMe(this)" id="comments-form">
  ...
  <tr valign="top" align="left">
    ...
    <input type="hidden" name="entry_id" value="376" /></td>
  </tr>
...
<p id="path"><a href="<?= $blogrelurl ?>">E.C.C Tours of Duty</a> > <a href="<?= $galleryurl ?>"><?= $gallerytitle ?></a> > <a href="<?= $galleryurl ?>gallery/">Gallery</a> > Robby</p>
