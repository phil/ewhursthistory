...
include ($_SERVER['DOCUMENT_ROOT']."/ecc/photos//galleryinfo.php");
  ...
  $section = "photosolo";
  $pgtitle = "And they romance is dead";
  $entryid = 543;
  $img = '<img alt="And they romance is dead" src="http://www.whatisnext.co.uk/ecc/photos/assets/2005-08-19-02-56-25.jpg" width="640" height="480" />';
...
<div id="Wrapper" class="Relative">
	...
	<div id="Document">
		...
		<div id="DocumentContent">
			...
			<p id="GalleryPath"><a href="<?= $blogrelurl ?>">E.C.C Tours of Duty</a> > <a href="<?= $galleryurl ?>"><?= $gallerytitle ?></a> > <a href="<?= $galleryurl ?>gallery/">Gallery</a> > And they romance is dead</p>  
			
			<div id="Photo"><img alt="And they romance is dead" src="http://www.whatisnext.co.uk/ecc/photos/assets/2005-08-19-02-56-25.jpg" width="640" height="480" /></div>
