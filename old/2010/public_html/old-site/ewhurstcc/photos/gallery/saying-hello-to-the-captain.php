...
include ($_SERVER['DOCUMENT_ROOT']."/ecc/photos//galleryinfo.php");
  ...
  $section = "photosolo";
  $pgtitle = "Saying hello to the captain";
  $entryid = 529;
  $img = '<img alt="Saying hello to the captain" src="http://www.whatisnext.co.uk/ecc/photos/assets/2005-08-18-02-48-50.jpg" width="640" height="480" />';
...
<div id="Wrapper" class="Relative">
	...
	<div id="Document">
		...
		<div id="DocumentContent">
			...
			<p id="GalleryPath"><a href="<?= $blogrelurl ?>">E.C.C Tours of Duty</a> > <a href="<?= $galleryurl ?>"><?= $gallerytitle ?></a> > <a href="<?= $galleryurl ?>gallery/">Gallery</a> > Saying hello to the captain</p>  
			
			<div id="Photo"><img alt="Saying hello to the captain" src="http://www.whatisnext.co.uk/ecc/photos/assets/2005-08-18-02-48-50.jpg" width="640" height="480" /></div>
