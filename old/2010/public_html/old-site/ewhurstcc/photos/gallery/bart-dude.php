...
include ($_SERVER['DOCUMENT_ROOT']."/ecc/photos//galleryinfo.php");
  ...
  $pgtitle = "Bart dude";
  $entryid = 426;
  $img = '<img alt="Bart dude" src="http://www.whatisnext.co.uk/ecc/photos/assets/2003-09-28-01-26-38.jpg" width="480" height="640" />';
...
<div id="Wrapper" class="Relative">
	...
	<div id="Document">
		...
		<div id="DocumentContent">
			...
			<p id="GalleryPath"><a href="<?= $blogrelurl ?>">E.C.C Tours of Duty</a> > <a href="<?= $galleryurl ?>"><?= $gallerytitle ?></a> > <a href="<?= $galleryurl ?>gallery/">Gallery</a> > Bart dude</p>  
			
			<div id="Photo"><img alt="Bart dude" src="http://www.whatisnext.co.uk/ecc/photos/assets/2003-09-28-01-26-38.jpg" width="480" height="640" /></div>
