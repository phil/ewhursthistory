...
include ($_SERVER['DOCUMENT_ROOT']."/ecc/photos//galleryinfo.php");
  ...
  $section = "photosolo";
  $pgtitle = "Not long to go now";
  $entryid = 541;
  $img = '<img alt="Not long to go now" src="http://www.whatisnext.co.uk/ecc/photos/assets/2005-08-19-02-18-31.jpg" width="640" height="480" />';
...
<div id="Wrapper" class="Relative">
	...
	<div id="Document">
		...
		<div id="DocumentContent">
			...
			<p id="GalleryPath"><a href="<?= $blogrelurl ?>">E.C.C Tours of Duty</a> > <a href="<?= $galleryurl ?>"><?= $gallerytitle ?></a> > <a href="<?= $galleryurl ?>gallery/">Gallery</a> > Not long to go now</p>  
			
			<div id="Photo"><img alt="Not long to go now" src="http://www.whatisnext.co.uk/ecc/photos/assets/2005-08-19-02-18-31.jpg" width="640" height="480" /></div>
