...
include ($_SERVER['DOCUMENT_ROOT']."/ecc/photos//galleryinfo.php");
  ...
  $section = "photosolo";
  $pgtitle = "ello, ello, ello";
  $entryid = 461;
  $img = '<img alt="ello, ello, ello" src="http://www.whatisnext.co.uk/ecc/photos/assets/2003-09-30-02-36-50.jpg" width="640" height="480" />';
...
<div id="Wrapper" class="Relative">
	...
	<div id="Document">
		...
		<div id="DocumentContent">
			...
			<p id="GalleryPath"><a href="<?= $blogrelurl ?>">E.C.C Tours of Duty</a> > <a href="<?= $galleryurl ?>"><?= $gallerytitle ?></a> > <a href="<?= $galleryurl ?>gallery/">Gallery</a> > ello, ello, ello</p>  
			
			<div id="Photo"><img alt="ello, ello, ello" src="http://www.whatisnext.co.uk/ecc/photos/assets/2003-09-30-02-36-50.jpg" width="640" height="480" /></div>
			
			<div id="PhotoInfo">
				<h1>E.C.C Tours of Duty</h1>
				<p>I think Alex has an admirer</p>
			</div>
			<div id="PhotoMeta">
				<ul>
					<li class="count">Photo # of #</li>
					<li class="date">30 September 2003</li>
