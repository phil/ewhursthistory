<?php
  ...
  $section = "photosolo";
  $pgtitle = "Johnny and Parry";
  $entryid = 337;
  $img = '<img alt="Johnny and Parry" src="http://www.whatisnext.co.uk/ecc/photosassets/2005-08-18-00-02-36.jpg" width="640" height="480" />';
  $opencomments = true;
...
<div id="desc">
  <h1>Johnny and Parry</h1>
  <p>In the worst club in Newquey</p>
</div>
...
<form method="post" action="http://www.whatisnext.co.uk/cgi-bin/mt/mt-comments.cgi" onsubmit="if (this.bakecookie[0].checked) rememberMe(this)" id="comments-form">
  ...
  <tr valign="top" align="left">
    ...
    <input type="hidden" name="entry_id" value="337" /></td>
  </tr>
...
<p id="path"><a href="<?= $blogrelurl ?>">E.C.C Tours of Duty</a> > <a href="<?= $galleryurl ?>"><?= $gallerytitle ?></a> > <a href="<?= $galleryurl ?>gallery/">Gallery</a> > Johnny and Parry</p>
