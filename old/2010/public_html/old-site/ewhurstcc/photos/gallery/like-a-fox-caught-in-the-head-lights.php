<?php
  ...
  $section = "photosolo";
  $pgtitle = "Like a fox caught in the head lights";
  $entryid = 366;
  $img = '<img alt="Like a fox caught in the head lights" src="http://www.whatisnext.co.uk/ecc/photosassets/2005-08-18-02-32-42.jpg" width="480" height="640" />';
  $opencomments = true;
...
<div id="desc">
  <h1>Like a fox caught in the head lights</h1>
...
<form method="post" action="http://www.whatisnext.co.uk/cgi-bin/mt/mt-comments.cgi" onsubmit="if (this.bakecookie[0].checked) rememberMe(this)" id="comments-form">
  ...
  <tr valign="top" align="left">
    ...
    <input type="hidden" name="entry_id" value="366" /></td>
  </tr>
...
<p id="path"><a href="<?= $blogrelurl ?>">E.C.C Tours of Duty</a> > <a href="<?= $galleryurl ?>"><?= $gallerytitle ?></a> > <a href="<?= $galleryurl ?>gallery/">Gallery</a> > Like a fox caught in the head lights</p>
