...
include ($_SERVER['DOCUMENT_ROOT']."/ecc/photos//galleryinfo.php");
  ...
  $section = "photosolo";
  $pgtitle = "Jez Looks stunned";
  $entryid = 477;
  $img = '<img alt="Jez Looks stunned" src="http://www.whatisnext.co.uk/ecc/photos/assets/2004-08-13-03-56-37.jpg" width="640" height="480" />';
...
<div id="Wrapper" class="Relative">
	...
	<div id="Document">
		...
		<div id="DocumentContent">
			...
			<p id="GalleryPath"><a href="<?= $blogrelurl ?>">E.C.C Tours of Duty</a> > <a href="<?= $galleryurl ?>"><?= $gallerytitle ?></a> > <a href="<?= $galleryurl ?>gallery/">Gallery</a> > Jez Looks stunned</p>  
			
			<div id="Photo"><img alt="Jez Looks stunned" src="http://www.whatisnext.co.uk/ecc/photos/assets/2004-08-13-03-56-37.jpg" width="640" height="480" /></div>
