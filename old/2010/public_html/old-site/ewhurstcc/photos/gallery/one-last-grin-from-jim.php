<?php
  ...
  $section = "photosolo";
  $pgtitle = "One last grin from Jim";
  $entryid = 318;
  $img = '<img alt="One last grin from Jim" src="http://www.whatisnext.co.uk/ecc/photosassets/2004-08-13-17-55-28.jpg" width="640" height="480" />';
  $opencomments = true;
...
<div id="desc">
  <h1>One last grin from Jim</h1>
  <p>Cowes and in the background</p>
</div>
...
<form method="post" action="http://www.whatisnext.co.uk/cgi-bin/mt/mt-comments.cgi" onsubmit="if (this.bakecookie[0].checked) rememberMe(this)" id="comments-form">
  ...
  <tr valign="top" align="left">
    ...
    <input type="hidden" name="entry_id" value="318" /></td>
  </tr>
...
<p id="path"><a href="<?= $blogrelurl ?>">E.C.C Tours of Duty</a> > <a href="<?= $galleryurl ?>"><?= $gallerytitle ?></a> > <a href="<?= $galleryurl ?>gallery/">Gallery</a> > One last grin from Jim</p>
