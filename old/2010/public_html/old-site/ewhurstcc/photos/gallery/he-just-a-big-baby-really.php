<?php
  ...
  $section = "photosolo";
  $pgtitle = "He just a big baby really";
  $entryid = 262;
  $img = '<img alt="He just a big baby really" src="http://www.whatisnext.co.uk/ecc/photosassets/2004-08-09-23-07-34.jpg" width="640" height="480" />';
  $opencomments = true;
...
<div id="desc">
  <h1>He just a big baby really</h1>
  <p>Never go out for night in Newport. The Place is dead to the world</p>
</div>
...
<div id="main">
  ...
  <div id="meta">
    <ul>
      ...
      <li class="date"> 9 August 2004</li>
...
<form method="post" action="http://www.whatisnext.co.uk/cgi-bin/mt/mt-comments.cgi" onsubmit="if (this.bakecookie[0].checked) rememberMe(this)" id="comments-form">
  ...
  <tr valign="top" align="left">
    ...
    <input type="hidden" name="entry_id" value="262" /></td>
  </tr>
...
<p id="path"><a href="<?= $blogrelurl ?>">E.C.C Tours of Duty</a> > <a href="<?= $galleryurl ?>"><?= $gallerytitle ?></a> > <a href="<?= $galleryurl ?>gallery/">Gallery</a> > He just a big baby really</p>
