<?php
  ...
  $section = "photosolo";
  $pgtitle = "I see no ships?";
  $entryid = 308;
  $img = '<img alt="I see no ships?" src="http://www.whatisnext.co.uk/ecc/photosassets/2004-08-13-02-20-37.jpg" width="640" height="480" />';
  $opencomments = true;
...
<form method="post" action="http://www.whatisnext.co.uk/cgi-bin/mt/mt-comments.cgi" onsubmit="if (this.bakecookie[0].checked) rememberMe(this)" id="comments-form">
  ...
  <tr valign="top" align="left">
    ...
    <input type="hidden" name="entry_id" value="308" /></td>
  </tr>
...
<p id="path"><a href="<?= $blogrelurl ?>">E.C.C Tours of Duty</a> > <a href="<?= $galleryurl ?>"><?= $gallerytitle ?></a> > <a href="<?= $galleryurl ?>gallery/">Gallery</a> > I see no ships?</p>
