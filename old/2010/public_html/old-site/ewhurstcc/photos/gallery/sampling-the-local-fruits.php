<?php
  ...
  $section = "photosolo";
  $pgtitle = "Sampling the Local fruits";
  $entryid = 244;
  $img = '<img alt="Sampling the Local fruits" src="http://www.whatisnext.co.uk/ecc/photosassets/2003-07-24-11-25-00.jpg" width="638" height="367" />';
  $opencomments = true;
...
<div id="desc">
  <h1>Sampling the Local fruits</h1>
...
<div id="main">
  ...
  <div id="meta">
    <ul>
      ...
      <li class="date">24 July 2003</li>
      <li class="tags">ECC-Holland2003</li>
    </ul>
  </div>
...
<form method="post" action="http://www.whatisnext.co.uk/cgi-bin/mt/mt-comments.cgi" onsubmit="if (this.bakecookie[0].checked) rememberMe(this)" id="comments-form">
  ...
  <tr valign="top" align="left">
    ...
    <input type="hidden" name="entry_id" value="244" /></td>
  </tr>
...
<p id="path"><a href="<?= $blogrelurl ?>">E.C.C Tours of Duty</a> > <a href="<?= $galleryurl ?>"><?= $gallerytitle ?></a> > <a href="<?= $galleryurl ?>gallery/">Gallery</a> > Sampling the Local fruits</p>
