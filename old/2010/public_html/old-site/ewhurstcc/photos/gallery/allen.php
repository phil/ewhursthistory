...
include ($_SERVER['DOCUMENT_ROOT']."/ecc/photos//galleryinfo.php");
  ...
  $pgtitle = "Allen";
  $entryid = 500;
  $img = '<img alt="Allen" src="http://www.whatisnext.co.uk/ecc/photos/assets/2005-08-16-03-52-59.jpg" width="640" height="480" />';
...
<div id="Wrapper" class="Relative">
	...
	<div id="Document">
		...
		<div id="DocumentContent">
			...
			<p id="GalleryPath"><a href="<?= $blogrelurl ?>">E.C.C Tours of Duty</a> > <a href="<?= $galleryurl ?>"><?= $gallerytitle ?></a> > <a href="<?= $galleryurl ?>gallery/">Gallery</a> > Allen</p>  
			
			<div id="Photo"><img alt="Allen" src="http://www.whatisnext.co.uk/ecc/photos/assets/2005-08-16-03-52-59.jpg" width="640" height="480" /></div>
