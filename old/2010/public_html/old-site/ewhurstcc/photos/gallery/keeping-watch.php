...
include ($_SERVER['DOCUMENT_ROOT']."/ecc/photos//galleryinfo.php");
  ...
  $section = "photosolo";
  $pgtitle = "Keeping watch";
  $entryid = 453;
  $img = '<img alt="Keeping watch" src="http://www.whatisnext.co.uk/ecc/photos/assets/2003-09-29-21-22-44.jpg" width="640" height="480" />';
...
<div id="Wrapper" class="Relative">
	...
	<div id="Document">
		...
		<div id="DocumentContent">
			...
			<p id="GalleryPath"><a href="<?= $blogrelurl ?>">E.C.C Tours of Duty</a> > <a href="<?= $galleryurl ?>"><?= $gallerytitle ?></a> > <a href="<?= $galleryurl ?>gallery/">Gallery</a> > Keeping watch</p>  
			
			<div id="Photo"><img alt="Keeping watch" src="http://www.whatisnext.co.uk/ecc/photos/assets/2003-09-29-21-22-44.jpg" width="640" height="480" /></div>
