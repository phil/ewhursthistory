...
include ($_SERVER['DOCUMENT_ROOT']."/ecc/photos//galleryinfo.php");
  ...
  $pgtitle = "Finger";
  $entryid = 511;
  $img = '<img alt="Finger" src="http://www.whatisnext.co.uk/ecc/photos/assets/2005-08-17-01-06-15.jpg" width="640" height="480" />';
...
<div id="Wrapper" class="Relative">
	...
	<div id="Document">
		...
		<div id="DocumentContent">
			...
			<p id="GalleryPath"><a href="<?= $blogrelurl ?>">E.C.C Tours of Duty</a> > <a href="<?= $galleryurl ?>"><?= $gallerytitle ?></a> > <a href="<?= $galleryurl ?>gallery/">Gallery</a> > Finger</p>  
			
			<div id="Photo"><img alt="Finger" src="http://www.whatisnext.co.uk/ecc/photos/assets/2005-08-17-01-06-15.jpg" width="640" height="480" /></div>
