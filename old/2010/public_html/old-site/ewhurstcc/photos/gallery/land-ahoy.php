...
include ($_SERVER['DOCUMENT_ROOT']."/ecc/photos//galleryinfo.php");
  ...
  $pgtitle = "Land a&#8217;hoy";
  $entryid = 507;
  $img = '<img alt="Land a\'hoy" src="http://www.whatisnext.co.uk/ecc/photos/assets/2005-08-16-23-52-52.jpg" width="640" height="480" />';
...
<div id="Wrapper" class="Relative">
	...
	<div id="Document">
		...
		<div id="DocumentContent">
			...
			<p id="GalleryPath"><a href="<?= $blogrelurl ?>">E.C.C Tours of Duty</a> > <a href="<?= $galleryurl ?>"><?= $gallerytitle ?></a> > <a href="<?= $galleryurl ?>gallery/">Gallery</a> > Land a&#8217;hoy</p>  
			
			<div id="Photo"><img alt="Land a\'hoy" src="http://www.whatisnext.co.uk/ecc/photos/assets/2005-08-16-23-52-52.jpg" width="640" height="480" /></div>
