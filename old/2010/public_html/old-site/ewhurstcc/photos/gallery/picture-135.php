...
include ($_SERVER['DOCUMENT_ROOT']."/ecc/photos//galleryinfo.php");
  ...
  $pgtitle = "Picture 135";
  $entryid = 538;
  $img = '<img alt="Picture 135" src="http://www.whatisnext.co.uk/ecc/photos/assets/2005-08-19-01-42-44.jpg" width="640" height="480" />';
...
<div id="Wrapper" class="Relative">
	...
	<div id="Document">
		...
		<div id="DocumentContent">
			...
			<p id="GalleryPath"><a href="<?= $blogrelurl ?>">E.C.C Tours of Duty</a> > <a href="<?= $galleryurl ?>"><?= $gallerytitle ?></a> > <a href="<?= $galleryurl ?>gallery/">Gallery</a> > Picture 135</p>  
			
			<div id="Photo"><img alt="Picture 135" src="http://www.whatisnext.co.uk/ecc/photos/assets/2005-08-19-01-42-44.jpg" width="640" height="480" /></div>
