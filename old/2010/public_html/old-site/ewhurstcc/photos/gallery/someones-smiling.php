...
include ($_SERVER['DOCUMENT_ROOT']."/ecc/photos//galleryinfo.php");
  ...
  $section = "photosolo";
  $pgtitle = "Someones smiling";
  $entryid = 498;
  $img = '<img alt="Someones smiling" src="http://www.whatisnext.co.uk/ecc/photos/assets/2005-08-16-03-42-49.jpg" width="640" height="480" />';
...
<div id="Wrapper" class="Relative">
	...
	<div id="Document">
		...
		<div id="DocumentContent">
			...
			<p id="GalleryPath"><a href="<?= $blogrelurl ?>">E.C.C Tours of Duty</a> > <a href="<?= $galleryurl ?>"><?= $gallerytitle ?></a> > <a href="<?= $galleryurl ?>gallery/">Gallery</a> > Someones smiling</p>  
			
			<div id="Photo"><img alt="Someones smiling" src="http://www.whatisnext.co.uk/ecc/photos/assets/2005-08-16-03-42-49.jpg" width="640" height="480" /></div>
