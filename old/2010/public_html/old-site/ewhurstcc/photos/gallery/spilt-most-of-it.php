...
include ($_SERVER['DOCUMENT_ROOT']."/ecc/photos//galleryinfo.php");
  ...
  $section = "photosolo";
  $pgtitle = "Spilt most of it!";
  $entryid = 493;
  $img = '<img alt="Spilt most of it!" src="http://www.whatisnext.co.uk/ecc/photos/assets/2005-08-15-22-42-31.jpg" width="640" height="480" />';
...
<div id="Wrapper" class="Relative">
	...
	<div id="Document">
		...
		<div id="DocumentContent">
			...
			<p id="GalleryPath"><a href="<?= $blogrelurl ?>">E.C.C Tours of Duty</a> > <a href="<?= $galleryurl ?>"><?= $gallerytitle ?></a> > <a href="<?= $galleryurl ?>gallery/">Gallery</a> > Spilt most of it!</p>  
			
			<div id="Photo"><img alt="Spilt most of it!" src="http://www.whatisnext.co.uk/ecc/photos/assets/2005-08-15-22-42-31.jpg" width="640" height="480" /></div>
