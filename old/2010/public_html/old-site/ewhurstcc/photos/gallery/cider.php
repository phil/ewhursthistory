...
include ($_SERVER['DOCUMENT_ROOT']."/ecc/photos//galleryinfo.php");
  ...
  $pgtitle = "Cider";
  $entryid = 414;
  $img = '<img alt="Cider" src="http://www.whatisnext.co.uk/ecc/photos/assets/2003-09-27-20-33-10.jpg" width="480" height="640" />';
...
<div id="Wrapper" class="Relative">
	...
	<div id="Document">
		...
		<div id="DocumentContent">
			...
			<p id="GalleryPath"><a href="<?= $blogrelurl ?>">E.C.C Tours of Duty</a> > <a href="<?= $galleryurl ?>"><?= $gallerytitle ?></a> > <a href="<?= $galleryurl ?>gallery/">Gallery</a> > Cider</p>  
			
			<div id="Photo"><img alt="Cider" src="http://www.whatisnext.co.uk/ecc/photos/assets/2003-09-27-20-33-10.jpg" width="480" height="640" /></div>
