<?php
  ...
  $section = "photosolo";
  $pgtitle = "Cation, and some Cider";
  $entryid = 330;
  $img = '<img alt="Cation, and some Cider" src="http://www.whatisnext.co.uk/ecc/photosassets/2005-08-17-18-43-00.jpg" width="480" height="640" />';
  $opencomments = true;
...
<div id="desc">
  <h1>Cation, and some Cider</h1>
  <p>Man of the Match, well, the on ewho batted longer than 5 balls anyway</p>
</div>
...
<form method="post" action="http://www.whatisnext.co.uk/cgi-bin/mt/mt-comments.cgi" onsubmit="if (this.bakecookie[0].checked) rememberMe(this)" id="comments-form">
  ...
  <tr valign="top" align="left">
    ...
    <input type="hidden" name="entry_id" value="330" /></td>
  </tr>
...
<p id="path"><a href="<?= $blogrelurl ?>">E.C.C Tours of Duty</a> > <a href="<?= $galleryurl ?>"><?= $gallerytitle ?></a> > <a href="<?= $galleryurl ?>gallery/">Gallery</a> > Cation, and some Cider</p>
