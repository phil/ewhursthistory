<?php
  ...
  $section = "photosolo";
  $pgtitle = "Monday, Ready to depart on the Ferry";
  $entryid = 253;
  $img = '<img alt="Monday, Ready to depart on the Ferry" src="http://www.whatisnext.co.uk/ecc/photosassets/2004-08-09-10-15-28.jpg" width="640" height="480" />';
  $opencomments = true;
...
<div id="desc">
  <h1>Monday, Ready to depart on the Ferry</h1>
...
<form method="post" action="http://www.whatisnext.co.uk/cgi-bin/mt/mt-comments.cgi" onsubmit="if (this.bakecookie[0].checked) rememberMe(this)" id="comments-form">
  ...
  <tr valign="top" align="left">
    ...
    <input type="hidden" name="entry_id" value="253" /></td>
  </tr>
...
<p id="path"><a href="<?= $blogrelurl ?>">E.C.C Tours of Duty</a> > <a href="<?= $galleryurl ?>"><?= $gallerytitle ?></a> > <a href="<?= $galleryurl ?>gallery/">Gallery</a> > Monday, Ready to depart on the Ferry</p>
