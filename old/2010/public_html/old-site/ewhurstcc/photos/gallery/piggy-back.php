<?php
  ...
  $pgtitle = "Piggy back";
  $entryid = 354;
  $img = '<img alt="Piggy back" src="http://www.whatisnext.co.uk/ecc/photosassets/2005-08-18-02-21-05.jpg" width="640" height="480" />';
  $opencomments = true;
...
<form method="post" action="http://www.whatisnext.co.uk/cgi-bin/mt/mt-comments.cgi" onsubmit="if (this.bakecookie[0].checked) rememberMe(this)" id="comments-form">
  ...
  <tr valign="top" align="left">
    ...
    <input type="hidden" name="entry_id" value="354" /></td>
  </tr>
...
<p id="path"><a href="<?= $blogrelurl ?>">E.C.C Tours of Duty</a> > <a href="<?= $galleryurl ?>"><?= $gallerytitle ?></a> > <a href="<?= $galleryurl ?>gallery/">Gallery</a> > Piggy back</p>
