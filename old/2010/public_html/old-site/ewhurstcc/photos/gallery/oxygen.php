...
include ($_SERVER['DOCUMENT_ROOT']."/ecc/photos//galleryinfo.php");
  ...
  $pgtitle = "Oxygen";
  $entryid = 527;
  $img = '<img alt="Oxygen" src="http://www.whatisnext.co.uk/ecc/photos/assets/2005-08-18-01-53-27.jpg" width="640" height="480" />';
...
<div id="Wrapper" class="Relative">
	...
	<div id="Document">
		...
		<div id="DocumentContent">
			...
			<p id="GalleryPath"><a href="<?= $blogrelurl ?>">E.C.C Tours of Duty</a> > <a href="<?= $galleryurl ?>"><?= $gallerytitle ?></a> > <a href="<?= $galleryurl ?>gallery/">Gallery</a> > Oxygen</p>  
			
			<div id="Photo"><img alt="Oxygen" src="http://www.whatisnext.co.uk/ecc/photos/assets/2005-08-18-01-53-27.jpg" width="640" height="480" /></div>
