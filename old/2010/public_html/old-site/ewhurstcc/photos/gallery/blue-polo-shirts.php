<?php
  ...
  $section = "photosolo";
  $pgtitle = "Blue Polo shirts";
  $entryid = 250;
  $img = '<img alt="Blue Polo shirts" src="http://www.whatisnext.co.uk/ecc/photosassets/2003-07-25-10-03-00.jpg" width="638" height="367" />';
  $opencomments = true;
...
<form method="post" action="http://www.whatisnext.co.uk/cgi-bin/mt/mt-comments.cgi" onsubmit="if (this.bakecookie[0].checked) rememberMe(this)" id="comments-form">
  ...
  <tr valign="top" align="left">
    ...
    <input type="hidden" name="entry_id" value="250" /></td>
  </tr>
...
<p id="path"><a href="<?= $blogrelurl ?>">E.C.C Tours of Duty</a> > <a href="<?= $galleryurl ?>"><?= $gallerytitle ?></a> > <a href="<?= $galleryurl ?>gallery/">Gallery</a> > Blue Polo shirts</p>
