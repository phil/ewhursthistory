<?php
  ...
  $section = "photosolo";
  $pgtitle = "St Just Jimmy, Working the Magic?";
  $entryid = 408;
  $img = '<img alt="St Just Jimmy, Working the Magic?" src="http://www.whatisnext.co.uk/ecc/photosassets/2005-08-19-03-05-58.jpg" width="640" height="480" />';
  $opencomments = true;
...
<div id="desc">
  <h1>St Just Jimmy, Working the Magic?</h1>
  <p>Well, no. In fact hes trying the impossible. Explaining the rules of crciket to a lady</p>
</div>
...
<form method="post" action="http://www.whatisnext.co.uk/cgi-bin/mt/mt-comments.cgi" onsubmit="if (this.bakecookie[0].checked) rememberMe(this)" id="comments-form">
  ...
  <tr valign="top" align="left">
    ...
    <input type="hidden" name="entry_id" value="408" /></td>
  </tr>
...
<p id="path"><a href="<?= $blogrelurl ?>">E.C.C Tours of Duty</a> > <a href="<?= $galleryurl ?>"><?= $gallerytitle ?></a> > <a href="<?= $galleryurl ?>gallery/">Gallery</a> > St Just Jimmy, Working the Magic?</p>
