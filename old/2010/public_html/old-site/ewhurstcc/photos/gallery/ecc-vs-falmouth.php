...
include ($_SERVER['DOCUMENT_ROOT']."/ecc/photos//galleryinfo.php");
  ...
  $section = "photosolo";
  $pgtitle = "ECC vs Falmouth";
  $entryid = 488;
  $img = '<img alt="ECC vs Falmouth" src="http://www.whatisnext.co.uk/ecc/photos/assets/2005-08-15-20-09-33.jpg" width="640" height="480" />';
...
<div id="Wrapper" class="Relative">
	...
	<div id="Document">
		...
		<div id="DocumentContent">
			...
			<p id="GalleryPath"><a href="<?= $blogrelurl ?>">E.C.C Tours of Duty</a> > <a href="<?= $galleryurl ?>"><?= $gallerytitle ?></a> > <a href="<?= $galleryurl ?>gallery/">Gallery</a> > ECC vs Falmouth</p>  
			
			<div id="Photo"><img alt="ECC vs Falmouth" src="http://www.whatisnext.co.uk/ecc/photos/assets/2005-08-15-20-09-33.jpg" width="640" height="480" /></div>
