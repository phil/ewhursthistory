<?php
  ...
  $pgtitle = "Down in one";
  $entryid = 331;
  $img = '<img alt="Down in one" src="http://www.whatisnext.co.uk/ecc/photosassets/2005-08-17-18-44-12.jpg" width="480" height="640" />';
  $opencomments = true;
...
<div id="desc">
  <h1>Down in one</h1>
  <p>The trick is to get the bottom bit right</p>
</div>
...
<form method="post" action="http://www.whatisnext.co.uk/cgi-bin/mt/mt-comments.cgi" onsubmit="if (this.bakecookie[0].checked) rememberMe(this)" id="comments-form">
  ...
  <tr valign="top" align="left">
    ...
    <input type="hidden" name="entry_id" value="331" /></td>
  </tr>
...
<p id="path"><a href="<?= $blogrelurl ?>">E.C.C Tours of Duty</a> > <a href="<?= $galleryurl ?>"><?= $gallerytitle ?></a> > <a href="<?= $galleryurl ?>gallery/">Gallery</a> > Down in one</p>
