<?php
  ...
  $section = "photosolo";
  $pgtitle = "Parry, the morning after";
  $entryid = 410;
  $img = '<img alt="Parry, the morning after" src="http://www.whatisnext.co.uk/ecc/photosassets/2005-08-19-10-46-48.jpg" width="480" height="640" />';
  $opencomments = true;
...
<div id="desc">
  <h1>Parry, the morning after</h1>
  <p>He wasn&#8217;t coming back with us, he was off the station, still very drunk.</p>
</div>
...
<form method="post" action="http://www.whatisnext.co.uk/cgi-bin/mt/mt-comments.cgi" onsubmit="if (this.bakecookie[0].checked) rememberMe(this)" id="comments-form">
  ...
  <tr valign="top" align="left">
    ...
    <input type="hidden" name="entry_id" value="410" /></td>
  </tr>
...
<p id="path"><a href="<?= $blogrelurl ?>">E.C.C Tours of Duty</a> > <a href="<?= $galleryurl ?>"><?= $gallerytitle ?></a> > <a href="<?= $galleryurl ?>gallery/">Gallery</a> > Parry, the morning after</p>
