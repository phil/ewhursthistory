<?php
  ...
  $pgtitle = "Duuuurrrrrr&#8230; . ";
  $entryid = 282;
  $img = '<img alt="Duuuurrrrrr. . . . " src="http://www.whatisnext.co.uk/ecc/photosassets/2004-08-13-01-18-23.jpg" width="480" height="640" />';
  $opencomments = true;
...
<div id="desc">
  <h1>Duuuurrrrrr&#8230; . </h1>
  <p>Mean while, Creedy drinks Red Bull?</p>
</div>
...
<form method="post" action="http://www.whatisnext.co.uk/cgi-bin/mt/mt-comments.cgi" onsubmit="if (this.bakecookie[0].checked) rememberMe(this)" id="comments-form">
  ...
  <tr valign="top" align="left">
    ...
    <input type="hidden" name="entry_id" value="282" /></td>
  </tr>
...
<p id="path"><a href="<?= $blogrelurl ?>">E.C.C Tours of Duty</a> > <a href="<?= $galleryurl ?>"><?= $gallerytitle ?></a> > <a href="<?= $galleryurl ?>gallery/">Gallery</a> > Duuuurrrrrr&#8230; . </p>
