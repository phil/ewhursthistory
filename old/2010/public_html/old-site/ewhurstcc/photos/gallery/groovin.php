<?php
  ...
  $pgtitle = "Groovin";
  $entryid = 401;
  $img = '<img alt="Groovin" src="http://www.whatisnext.co.uk/ecc/photosassets/2005-08-19-01-26-56.jpg" width="640" height="480" />';
  $opencomments = true;
...
<div id="desc">
  <h1>Groovin</h1>
  <p>Darryl with a girl from our hotel</p>
</div>
...
<form method="post" action="http://www.whatisnext.co.uk/cgi-bin/mt/mt-comments.cgi" onsubmit="if (this.bakecookie[0].checked) rememberMe(this)" id="comments-form">
  ...
  <tr valign="top" align="left">
    ...
    <input type="hidden" name="entry_id" value="401" /></td>
  </tr>
...
<p id="path"><a href="<?= $blogrelurl ?>">E.C.C Tours of Duty</a> > <a href="<?= $galleryurl ?>"><?= $gallerytitle ?></a> > <a href="<?= $galleryurl ?>gallery/">Gallery</a> > Groovin</p>
