<?php
  ...
  $pgtitle = "Duck Boy";
  $entryid = 271;
  $img = '<img alt="Duck Boy" src="http://www.whatisnext.co.uk/ecc/photosassets/2004-08-10-20-56-02.jpg" width="640" height="480" />';
  $opencomments = true;
...
<div id="desc">
  <h1>Duck Boy</h1>
  <p>He&#8217;s wearing a Duck, and a large Blue Dress. He had to wear them all day and night, tour rules</p>
</div>
...
<form method="post" action="http://www.whatisnext.co.uk/cgi-bin/mt/mt-comments.cgi" onsubmit="if (this.bakecookie[0].checked) rememberMe(this)" id="comments-form">
  ...
  <tr valign="top" align="left">
    ...
    <input type="hidden" name="entry_id" value="271" /></td>
  </tr>
...
<p id="path"><a href="<?= $blogrelurl ?>">E.C.C Tours of Duty</a> > <a href="<?= $galleryurl ?>"><?= $gallerytitle ?></a> > <a href="<?= $galleryurl ?>gallery/">Gallery</a> > Duck Boy</p>
