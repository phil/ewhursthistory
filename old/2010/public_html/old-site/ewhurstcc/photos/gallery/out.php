...
include ($_SERVER['DOCUMENT_ROOT']."/ecc/photos//galleryinfo.php");
  ...
  $pgtitle = "Out?";
  $entryid = 492;
  $img = '<img alt="Out?" src="http://www.whatisnext.co.uk/ecc/photos/assets/2005-08-15-20-35-20.jpg" width="640" height="480" />';
...
<div id="Wrapper" class="Relative">
	...
	<div id="Document">
		...
		<div id="DocumentContent">
			...
			<p id="GalleryPath"><a href="<?= $blogrelurl ?>">E.C.C Tours of Duty</a> > <a href="<?= $galleryurl ?>"><?= $gallerytitle ?></a> > <a href="<?= $galleryurl ?>gallery/">Gallery</a> > Out?</p>  
			
			<div id="Photo"><img alt="Out?" src="http://www.whatisnext.co.uk/ecc/photos/assets/2005-08-15-20-35-20.jpg" width="640" height="480" /></div>
