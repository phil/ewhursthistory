...
include ($_SERVER['DOCUMENT_ROOT']."/ecc/photos//galleryinfo.php");
  ...
  $section = "photosolo";
  $pgtitle = "Best of Frends";
  $entryid = 469;
  $img = '<img alt="Best of Frends" src="http://www.whatisnext.co.uk/ecc/photos/assets/2004-08-12-22-34-48.jpg" width="640" height="480" />';
...
<div id="Wrapper" class="Relative">
	...
	<div id="Document">
		...
		<div id="DocumentContent">
			...
			<p id="GalleryPath"><a href="<?= $blogrelurl ?>">E.C.C Tours of Duty</a> > <a href="<?= $galleryurl ?>"><?= $gallerytitle ?></a> > <a href="<?= $galleryurl ?>gallery/">Gallery</a> > Best of Frends</p>  
			
			<div id="Photo"><img alt="Best of Frends" src="http://www.whatisnext.co.uk/ecc/photos/assets/2004-08-12-22-34-48.jpg" width="640" height="480" /></div>
