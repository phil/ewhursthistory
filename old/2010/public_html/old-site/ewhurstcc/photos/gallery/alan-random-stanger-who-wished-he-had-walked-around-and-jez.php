<?php
  ...
  $section = "photosolo";
  $pgtitle = "Alan, Random stanger who wished he had walked around, and Jez";
  $entryid = 403;
  $img = '<img alt="Alan, Random stanger who wished he had walked around, and Jez" src="http://www.whatisnext.co.uk/ecc/photosassets/2005-08-19-02-20-08.jpg" width="640" height="480" />';
  $opencomments = true;
...
<div id="desc">
  <h1>Alan, Random stanger who wished he had walked around, and Jez</h1>
  <p>Re-enacting the Thumbs incident from the night before</p>
</div>
...
<div id="main">
  ...
  <div id="meta">
    <ul>
      ...
      <li class="date">19 August 2005</li>
      <li class="tags">ECC-Cornwall2005</li>
    </ul>
  </div>
...
<form method="post" action="http://www.whatisnext.co.uk/cgi-bin/mt/mt-comments.cgi" onsubmit="if (this.bakecookie[0].checked) rememberMe(this)" id="comments-form">
  ...
  <tr valign="top" align="left">
    ...
    <input type="hidden" name="entry_id" value="403" /></td>
  </tr>
...
<p id="path"><a href="<?= $blogrelurl ?>">E.C.C Tours of Duty</a> > <a href="<?= $galleryurl ?>"><?= $gallerytitle ?></a> > <a href="<?= $galleryurl ?>gallery/">Gallery</a> > Alan, Random stanger who wished he had walked around, and Jez</p>
