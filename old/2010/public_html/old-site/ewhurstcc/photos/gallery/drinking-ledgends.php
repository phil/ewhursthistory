<?php
  ...
  $section = "photosolo";
  $pgtitle = "Drinking Ledgends";
  $entryid = 393;
  $img = '<img alt="Drinking Ledgends" src="http://www.whatisnext.co.uk/ecc/photosassets/2005-08-18-22-50-09.jpg" width="640" height="480" />';
  $opencomments = true;
...
<div id="desc">
  <h1>Drinking Ledgends</h1>
  <p>Robby, Mental and the new boy on the block, Darryl</p>
</div>
...
<form method="post" action="http://www.whatisnext.co.uk/cgi-bin/mt/mt-comments.cgi" onsubmit="if (this.bakecookie[0].checked) rememberMe(this)" id="comments-form">
  ...
  <tr valign="top" align="left">
    ...
    <input type="hidden" name="entry_id" value="393" /></td>
  </tr>
...
<p id="path"><a href="<?= $blogrelurl ?>">E.C.C Tours of Duty</a> > <a href="<?= $galleryurl ?>"><?= $gallerytitle ?></a> > <a href="<?= $galleryurl ?>gallery/">Gallery</a> > Drinking Ledgends</p>
