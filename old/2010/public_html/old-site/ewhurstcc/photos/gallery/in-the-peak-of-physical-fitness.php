...
include ($_SERVER['DOCUMENT_ROOT']."/ecc/photos//galleryinfo.php");
  ...
  $section = "photosolo";
  $pgtitle = "In the peak of physical fitness";
  $entryid = 514;
  $img = '<img alt="In the peak of physical fitness" src="http://www.whatisnext.co.uk/ecc/photos/assets/2005-08-17-15-27-56.jpg" width="640" height="480" />';
...
<div id="Wrapper" class="Relative">
	...
	<div id="Document">
		...
		<div id="DocumentContent">
			...
			<p id="GalleryPath"><a href="<?= $blogrelurl ?>">E.C.C Tours of Duty</a> > <a href="<?= $galleryurl ?>"><?= $gallerytitle ?></a> > <a href="<?= $galleryurl ?>gallery/">Gallery</a> > In the peak of physical fitness</p>  
			
			<div id="Photo"><img alt="In the peak of physical fitness" src="http://www.whatisnext.co.uk/ecc/photos/assets/2005-08-17-15-27-56.jpg" width="640" height="480" /></div>
