...
include ($_SERVER['DOCUMENT_ROOT']."/ecc/photos//galleryinfo.php");
  ...
  $section = "photosolo";
  $pgtitle = "Man of the Match";
  $entryid = 520;
  $img = '<img alt="Man of the Match" src="http://www.whatisnext.co.uk/ecc/photos/assets/2005-08-17-19-57-30.jpg" width="640" height="480" />';
...
<div id="Wrapper" class="Relative">
	...
	<div id="Document">
		...
		<div id="DocumentContent">
			...
			<p id="GalleryPath"><a href="<?= $blogrelurl ?>">E.C.C Tours of Duty</a> > <a href="<?= $galleryurl ?>"><?= $gallerytitle ?></a> > <a href="<?= $galleryurl ?>gallery/">Gallery</a> > Man of the Match</p>  
			
			<div id="Photo"><img alt="Man of the Match" src="http://www.whatisnext.co.uk/ecc/photos/assets/2005-08-17-19-57-30.jpg" width="640" height="480" /></div>
