<?php
  ...
  $section = "photosolo";
  $pgtitle = "Re-inacting the surfing from earlier";
  $entryid = 375;
  $img = '<img alt="Re-inacting the surfing from earlier" src="http://www.whatisnext.co.uk/ecc/photosassets/2005-08-18-02-52-28.jpg" width="640" height="480" />';
  $opencomments = true;
...
<div id="desc">
  <h1>Re-inacting the surfing from earlier</h1>
...
<form method="post" action="http://www.whatisnext.co.uk/cgi-bin/mt/mt-comments.cgi" onsubmit="if (this.bakecookie[0].checked) rememberMe(this)" id="comments-form">
  ...
  <tr valign="top" align="left">
    ...
    <input type="hidden" name="entry_id" value="375" /></td>
  </tr>
...
<p id="path"><a href="<?= $blogrelurl ?>">E.C.C Tours of Duty</a> > <a href="<?= $galleryurl ?>"><?= $gallerytitle ?></a> > <a href="<?= $galleryurl ?>gallery/">Gallery</a> > Re-inacting the surfing from earlier</p>
