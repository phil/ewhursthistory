...
include ($_SERVER['DOCUMENT_ROOT']."/ecc/photos//galleryinfo.php");
  ...
  $pgtitle = "Post match";
  $entryid = 521;
  $img = '<img alt="Post match" src="http://www.whatisnext.co.uk/ecc/photos/assets/2005-08-17-20-26-15.jpg" width="640" height="480" />';
...
<div id="Wrapper" class="Relative">
	...
	<div id="Document">
		...
		<div id="DocumentContent">
			...
			<p id="GalleryPath"><a href="<?= $blogrelurl ?>">E.C.C Tours of Duty</a> > <a href="<?= $galleryurl ?>"><?= $gallerytitle ?></a> > <a href="<?= $galleryurl ?>gallery/">Gallery</a> > Post match</p>  
			
			<div id="Photo"><img alt="Post match" src="http://www.whatisnext.co.uk/ecc/photos/assets/2005-08-17-20-26-15.jpg" width="640" height="480" /></div>
