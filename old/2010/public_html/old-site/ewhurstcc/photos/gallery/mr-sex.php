...
include ($_SERVER['DOCUMENT_ROOT']."/ecc/photos//galleryinfo.php");
  ...
  $pgtitle = "Mr Sex";
  $entryid = 490;
  $img = '<img alt="Mr Sex" src="http://www.whatisnext.co.uk/ecc/photos/assets/2005-08-15-20-23-44.jpg" width="640" height="480" />';
...
<div id="Wrapper" class="Relative">
	...
	<div id="Document">
		...
		<div id="DocumentContent">
			...
			<p id="GalleryPath"><a href="<?= $blogrelurl ?>">E.C.C Tours of Duty</a> > <a href="<?= $galleryurl ?>"><?= $gallerytitle ?></a> > <a href="<?= $galleryurl ?>gallery/">Gallery</a> > Mr Sex</p>  
			
			<div id="Photo"><img alt="Mr Sex" src="http://www.whatisnext.co.uk/ecc/photos/assets/2005-08-15-20-23-44.jpg" width="640" height="480" /></div>
