<?php
  ...
  $section = "photosolo";
  $pgtitle = "Bundle on the Skip";
  $entryid = 355;
  $img = '<img alt="Bundle on the Skip" src="http://www.whatisnext.co.uk/ecc/photosassets/2005-08-18-02-22-59.jpg" width="480" height="640" />';
  $opencomments = true;
...
<form method="post" action="http://www.whatisnext.co.uk/cgi-bin/mt/mt-comments.cgi" onsubmit="if (this.bakecookie[0].checked) rememberMe(this)" id="comments-form">
  ...
  <tr valign="top" align="left">
    ...
    <input type="hidden" name="entry_id" value="355" /></td>
  </tr>
...
<p id="path"><a href="<?= $blogrelurl ?>">E.C.C Tours of Duty</a> > <a href="<?= $galleryurl ?>"><?= $gallerytitle ?></a> > <a href="<?= $galleryurl ?>gallery/">Gallery</a> > Bundle on the Skip</p>
