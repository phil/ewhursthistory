<?php
  ...
  $pgtitle = "Bliss";
  $entryid = 379;
  $img = '<img alt="Bliss" src="http://www.whatisnext.co.uk/ecc/photosassets/2005-08-18-03-09-30.jpg" width="640" height="480" />';
  $opencomments = true;
...
<div id="desc">
  <h1>Bliss</h1>
  <p>Dont stroke that bottle too much!</p>
</div>
...
<form method="post" action="http://www.whatisnext.co.uk/cgi-bin/mt/mt-comments.cgi" onsubmit="if (this.bakecookie[0].checked) rememberMe(this)" id="comments-form">
  ...
  <tr valign="top" align="left">
    ...
    <input type="hidden" name="entry_id" value="379" /></td>
  </tr>
...
<p id="path"><a href="<?= $blogrelurl ?>">E.C.C Tours of Duty</a> > <a href="<?= $galleryurl ?>"><?= $gallerytitle ?></a> > <a href="<?= $galleryurl ?>gallery/">Gallery</a> > Bliss</p>
