<?php
  ...
  $section = "photosolo";
  $pgtitle = "A minute later, it was gone";
  $entryid = 347;
  $img = '<img alt="A minute later, it was gone" src="http://www.whatisnext.co.uk/ecc/photosassets/2005-08-18-02-07-34.jpg" width="640" height="480" />';
  $opencomments = true;
...
<div id="desc">
  <h1>A minute later, it was gone</h1>
...
<form method="post" action="http://www.whatisnext.co.uk/cgi-bin/mt/mt-comments.cgi" onsubmit="if (this.bakecookie[0].checked) rememberMe(this)" id="comments-form">
  ...
  <tr valign="top" align="left">
    ...
    <input type="hidden" name="entry_id" value="347" /></td>
  </tr>
...
<p id="path"><a href="<?= $blogrelurl ?>">E.C.C Tours of Duty</a> > <a href="<?= $galleryurl ?>"><?= $gallerytitle ?></a> > <a href="<?= $galleryurl ?>gallery/">Gallery</a> > A minute later, it was gone</p>
