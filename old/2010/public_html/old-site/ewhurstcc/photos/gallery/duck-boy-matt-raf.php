...
include ($_SERVER['DOCUMENT_ROOT']."/ecc/photos//galleryinfo.php");
  ...
  $section = "photosolo";
  $pgtitle = "Duck boy, Matt, RAF";
  $entryid = 444;
  $img = '<img alt="Duck boy, Matt, RAF" src="http://www.whatisnext.co.uk/ecc/photos/assets/2003-09-28-19-12-34.jpg" width="640" height="480" />';
...
<div id="Wrapper" class="Relative">
	...
	<div id="Document">
		...
		<div id="DocumentContent">
			...
			<p id="GalleryPath"><a href="<?= $blogrelurl ?>">E.C.C Tours of Duty</a> > <a href="<?= $galleryurl ?>"><?= $gallerytitle ?></a> > <a href="<?= $galleryurl ?>gallery/">Gallery</a> > Duck boy, Matt, RAF</p>  
			
			<div id="Photo"><img alt="Duck boy, Matt, RAF" src="http://www.whatisnext.co.uk/ecc/photos/assets/2003-09-28-19-12-34.jpg" width="640" height="480" /></div>
