...
include ($_SERVER['DOCUMENT_ROOT']."/ecc/photos//galleryinfo.php");
  ...
  $pgtitle = "Job Done";
  $entryid = 445;
  $img = '<img alt="Job Done" src="http://www.whatisnext.co.uk/ecc/photos/assets/2003-09-28-19-12-49.jpg" width="480" height="640" />';
...
<div id="Wrapper" class="Relative">
	...
	<div id="Document">
		...
		<div id="DocumentContent">
			...
			<p id="GalleryPath"><a href="<?= $blogrelurl ?>">E.C.C Tours of Duty</a> > <a href="<?= $galleryurl ?>"><?= $gallerytitle ?></a> > <a href="<?= $galleryurl ?>gallery/">Gallery</a> > Job Done</p>  
			
			<div id="Photo"><img alt="Job Done" src="http://www.whatisnext.co.uk/ecc/photos/assets/2003-09-28-19-12-49.jpg" width="480" height="640" /></div>
