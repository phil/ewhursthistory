...
include ($_SERVER['DOCUMENT_ROOT']."/ecc/photos//galleryinfo.php");
  ...
  $section = "photosolo";
  $pgtitle = "Chris and Paz";
  $entryid = 462;
  $img = '<img alt="Chris and Paz" src="http://www.whatisnext.co.uk/ecc/photos/assets/2004-08-12-21-39-26.jpg" width="640" height="480" />';
...
<div id="Wrapper" class="Relative">
	...
	<div id="Document">
		...
		<div id="DocumentContent">
			...
			<p id="GalleryPath"><a href="<?= $blogrelurl ?>">E.C.C Tours of Duty</a> > <a href="<?= $galleryurl ?>"><?= $gallerytitle ?></a> > <a href="<?= $galleryurl ?>gallery/">Gallery</a> > Chris and Paz</p>  
			
			<div id="Photo"><img alt="Chris and Paz" src="http://www.whatisnext.co.uk/ecc/photos/assets/2004-08-12-21-39-26.jpg" width="640" height="480" /></div>
