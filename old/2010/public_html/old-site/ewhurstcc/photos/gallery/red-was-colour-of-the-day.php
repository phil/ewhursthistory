<?php
  ...
  $section = "photosolo";
  $pgtitle = "Red was colour of the day";
  $entryid = 259;
  $img = '<img alt="Red was colour of the day" src="http://www.whatisnext.co.uk/ecc/photosassets/2004-08-09-14-22-25.jpg" width="640" height="480" />';
  $opencomments = true;
...
<div id="desc">
  <h1>Red was colour of the day</h1>
...
<form method="post" action="http://www.whatisnext.co.uk/cgi-bin/mt/mt-comments.cgi" onsubmit="if (this.bakecookie[0].checked) rememberMe(this)" id="comments-form">
  ...
  <tr valign="top" align="left">
    ...
    <input type="hidden" name="entry_id" value="259" /></td>
  </tr>
...
<p id="path"><a href="<?= $blogrelurl ?>">E.C.C Tours of Duty</a> > <a href="<?= $galleryurl ?>"><?= $gallerytitle ?></a> > <a href="<?= $galleryurl ?>gallery/">Gallery</a> > Red was colour of the day</p>
