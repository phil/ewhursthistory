...
include ($_SERVER['DOCUMENT_ROOT']."/ecc/photos//galleryinfo.php");
  ...
  $pgtitle = "Put it away!";
  $entryid = 542;
  $img = '<img alt="Put it away!" src="http://www.whatisnext.co.uk/ecc/photos/assets/2005-08-19-02-19-33.jpg" width="640" height="480" />';
...
<div id="Wrapper" class="Relative">
	...
	<div id="Document">
		...
		<div id="DocumentContent">
			...
			<p id="GalleryPath"><a href="<?= $blogrelurl ?>">E.C.C Tours of Duty</a> > <a href="<?= $galleryurl ?>"><?= $gallerytitle ?></a> > <a href="<?= $galleryurl ?>gallery/">Gallery</a> > Put it away!</p>  
			
			<div id="Photo"><img alt="Put it away!" src="http://www.whatisnext.co.uk/ecc/photos/assets/2005-08-19-02-19-33.jpg" width="640" height="480" /></div>
