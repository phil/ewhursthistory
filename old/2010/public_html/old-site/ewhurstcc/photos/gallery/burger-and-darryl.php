<?php
  ...
  $section = "photosolo";
  $pgtitle = "Burger and Darryl";
  $entryid = 323;
  $img = '<img alt="Burger and Darryl" src="http://www.whatisnext.co.uk/ecc/photosassets/2005-08-16-19-17-47.jpg" width="480" height="640" />';
  $opencomments = true;
...
<div id="desc">
  <h1>Burger and Darryl</h1>
  <p>Orry wears that duck with pride</p>
</div>
...
<form method="post" action="http://www.whatisnext.co.uk/cgi-bin/mt/mt-comments.cgi" onsubmit="if (this.bakecookie[0].checked) rememberMe(this)" id="comments-form">
  ...
  <tr valign="top" align="left">
    ...
    <input type="hidden" name="entry_id" value="323" /></td>
  </tr>
...
<p id="path"><a href="<?= $blogrelurl ?>">E.C.C Tours of Duty</a> > <a href="<?= $galleryurl ?>"><?= $gallerytitle ?></a> > <a href="<?= $galleryurl ?>gallery/">Gallery</a> > Burger and Darryl</p>
