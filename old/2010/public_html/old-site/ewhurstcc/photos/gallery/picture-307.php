...
include ($_SERVER['DOCUMENT_ROOT']."/ecc/photos//galleryinfo.php");
  ...
  $pgtitle = "Picture 307";
  $entryid = 480;
  $img = '<img alt="Picture 307" src="http://www.whatisnext.co.uk/ecc/photos/assets/2005-08-05-00-11-51.jpg" width="640" height="480" />';
...
<div id="Wrapper" class="Relative">
	...
	<div id="Document">
		...
		<div id="DocumentContent">
			...
			<p id="GalleryPath"><a href="<?= $blogrelurl ?>">E.C.C Tours of Duty</a> > <a href="<?= $galleryurl ?>"><?= $gallerytitle ?></a> > <a href="<?= $galleryurl ?>gallery/">Gallery</a> > Picture 307</p>  
			
			<div id="Photo"><img alt="Picture 307" src="http://www.whatisnext.co.uk/ecc/photos/assets/2005-08-05-00-11-51.jpg" width="640" height="480" /></div>
