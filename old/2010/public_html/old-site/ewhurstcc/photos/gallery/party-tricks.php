...
include ($_SERVER['DOCUMENT_ROOT']."/ecc/photos//galleryinfo.php");
  ...
  $section = "photosolo";
  $pgtitle = "Party Tricks";
  $entryid = 533;
  $img = '<img alt="Party Tricks" src="http://www.whatisnext.co.uk/ecc/photos/assets/2005-08-18-03-29-02.jpg" width="640" height="480" />';
...
<div id="Wrapper" class="Relative">
	...
	<div id="Document">
		...
		<div id="DocumentContent">
			...
			<p id="GalleryPath"><a href="<?= $blogrelurl ?>">E.C.C Tours of Duty</a> > <a href="<?= $galleryurl ?>"><?= $gallerytitle ?></a> > <a href="<?= $galleryurl ?>gallery/">Gallery</a> > Party Tricks</p>  
			
			<div id="Photo"><img alt="Party Tricks" src="http://www.whatisnext.co.uk/ecc/photos/assets/2005-08-18-03-29-02.jpg" width="640" height="480" /></div>
