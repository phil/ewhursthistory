...
include ($_SERVER['DOCUMENT_ROOT']."/ecc/photos//galleryinfo.php");
  ...
  $pgtitle = "Picture 115";
  $entryid = 531;
  $img = '<img alt="Picture 115" src="http://www.whatisnext.co.uk/ecc/photos/assets/2005-08-18-02-45-01.jpg" width="640" height="480" />';
...
<div id="Wrapper" class="Relative">
	...
	<div id="Document">
		...
		<div id="DocumentContent">
			...
			<p id="GalleryPath"><a href="<?= $blogrelurl ?>">E.C.C Tours of Duty</a> > <a href="<?= $galleryurl ?>"><?= $gallerytitle ?></a> > <a href="<?= $galleryurl ?>gallery/">Gallery</a> > Picture 115</p>  
			
			<div id="Photo"><img alt="Picture 115" src="http://www.whatisnext.co.uk/ecc/photos/assets/2005-08-18-02-45-01.jpg" width="640" height="480" /></div>
