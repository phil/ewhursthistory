<?php
  ...
  $section = "photosolo";
  $pgtitle = "Parry and Happy Boy Chris";
  $entryid = 274;
  $img = '<img alt="Parry and Happy Boy Chris" src="http://www.whatisnext.co.uk/ecc/photosassets/2004-08-13-00-02-57.jpg" width="640" height="480" />';
  $opencomments = true;
...
<div id="desc">
  <h1>Parry and Happy Boy Chris</h1>
...
<form method="post" action="http://www.whatisnext.co.uk/cgi-bin/mt/mt-comments.cgi" onsubmit="if (this.bakecookie[0].checked) rememberMe(this)" id="comments-form">
  ...
  <tr valign="top" align="left">
    ...
    <input type="hidden" name="entry_id" value="274" /></td>
  </tr>
...
<p id="path"><a href="<?= $blogrelurl ?>">E.C.C Tours of Duty</a> > <a href="<?= $galleryurl ?>"><?= $gallerytitle ?></a> > <a href="<?= $galleryurl ?>gallery/">Gallery</a> > Parry and Happy Boy Chris</p>
