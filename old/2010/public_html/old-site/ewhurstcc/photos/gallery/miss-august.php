...
include ($_SERVER['DOCUMENT_ROOT']."/ecc/photos//galleryinfo.php");
  ...
  $pgtitle = "Miss August?";
  $entryid = 487;
  $img = '<img alt="Miss August?" src="http://www.whatisnext.co.uk/ecc/photos/assets/2005-08-15-20-09-10.jpg" width="640" height="480" />';
...
<div id="Wrapper" class="Relative">
	...
	<div id="Document">
		...
		<div id="DocumentContent">
			...
			<p id="GalleryPath"><a href="<?= $blogrelurl ?>">E.C.C Tours of Duty</a> > <a href="<?= $galleryurl ?>"><?= $gallerytitle ?></a> > <a href="<?= $galleryurl ?>gallery/">Gallery</a> > Miss August?</p>  
			
			<div id="Photo"><img alt="Miss August?" src="http://www.whatisnext.co.uk/ecc/photos/assets/2005-08-15-20-09-10.jpg" width="640" height="480" /></div>
