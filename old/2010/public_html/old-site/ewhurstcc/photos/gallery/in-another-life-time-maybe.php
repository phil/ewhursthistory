<?php
  ...
  $section = "photosolo";
  $pgtitle = "In Another life time, Maybe";
  $entryid = 286;
  $img = '<img alt="In Another life time, Maybe" src="http://www.whatisnext.co.uk/ecc/photosassets/2004-08-13-01-28-32.jpg" width="640" height="480" />';
  $opencomments = true;
...
<div id="desc">
  <h1>In Another life time, Maybe</h1>
...
<form method="post" action="http://www.whatisnext.co.uk/cgi-bin/mt/mt-comments.cgi" onsubmit="if (this.bakecookie[0].checked) rememberMe(this)" id="comments-form">
  ...
  <tr valign="top" align="left">
    ...
    <input type="hidden" name="entry_id" value="286" /></td>
  </tr>
...
<p id="path"><a href="<?= $blogrelurl ?>">E.C.C Tours of Duty</a> > <a href="<?= $galleryurl ?>"><?= $gallerytitle ?></a> > <a href="<?= $galleryurl ?>gallery/">Gallery</a> > In Another life time, Maybe</p>
