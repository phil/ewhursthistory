...
include ($_SERVER['DOCUMENT_ROOT']."/ecc/photos//galleryinfo.php");
  ...
  $section = "photosolo";
  $pgtitle = "A miniture Cation occupies the outfield";
  $entryid = 516;
  $img = '<img alt="A miniture Cation occupies the outfield" src="http://www.whatisnext.co.uk/ecc/photos/assets/2005-08-17-15-42-30.jpg" width="640" height="480" />';
...
<div id="Wrapper" class="Relative">
	...
	<div id="Document">
		...
		<div id="DocumentContent">
			...
			<p id="GalleryPath"><a href="<?= $blogrelurl ?>">E.C.C Tours of Duty</a> > <a href="<?= $galleryurl ?>"><?= $gallerytitle ?></a> > <a href="<?= $galleryurl ?>gallery/">Gallery</a> > A miniture Cation occupies the outfield</p>  
			
			<div id="Photo"><img alt="A miniture Cation occupies the outfield" src="http://www.whatisnext.co.uk/ecc/photos/assets/2005-08-17-15-42-30.jpg" width="640" height="480" /></div>
			...
			<div id="PhotoMeta">
				<ul>
					...
					<li class="date">17 August 2005</li>
