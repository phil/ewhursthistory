...
include ($_SERVER['DOCUMENT_ROOT']."/ecc/photos//galleryinfo.php");
  ...
  $pgtitle = "Paz + Jonny";
  $entryid = 457;
  $img = '<img alt="Paz + Jonny" src="http://www.whatisnext.co.uk/ecc/photos/assets/2003-09-29-22-40-11.jpg" width="640" height="480" />';
...
<div id="Wrapper" class="Relative">
	...
	<div id="Document">
		...
		<div id="DocumentContent">
			...
			<p id="GalleryPath"><a href="<?= $blogrelurl ?>">E.C.C Tours of Duty</a> > <a href="<?= $galleryurl ?>"><?= $gallerytitle ?></a> > <a href="<?= $galleryurl ?>gallery/">Gallery</a> > Paz + Jonny</p>  
			
			<div id="Photo"><img alt="Paz + Jonny" src="http://www.whatisnext.co.uk/ecc/photos/assets/2003-09-29-22-40-11.jpg" width="640" height="480" /></div>
