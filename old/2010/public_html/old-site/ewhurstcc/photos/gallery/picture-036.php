...
include ($_SERVER['DOCUMENT_ROOT']."/ecc/photos//galleryinfo.php");
  ...
  $pgtitle = "Picture 036";
  $entryid = 497;
  $img = '<img alt="Picture 036" src="http://www.whatisnext.co.uk/ecc/photos/assets/2005-08-16-01-18-03.jpg" width="640" height="480" />';
...
<div id="Wrapper" class="Relative">
	...
	<div id="Document">
		...
		<div id="DocumentContent">
			...
			<p id="GalleryPath"><a href="<?= $blogrelurl ?>">E.C.C Tours of Duty</a> > <a href="<?= $galleryurl ?>"><?= $gallerytitle ?></a> > <a href="<?= $galleryurl ?>gallery/">Gallery</a> > Picture 036</p>  
			
			<div id="Photo"><img alt="Picture 036" src="http://www.whatisnext.co.uk/ecc/photos/assets/2005-08-16-01-18-03.jpg" width="640" height="480" /></div>
