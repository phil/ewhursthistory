...
include ($_SERVER['DOCUMENT_ROOT']."/ecc/photos//galleryinfo.php");
  ...
  $section = "photosolo";
  $pgtitle = "On the night";
  $entryid = 510;
  $img = '<img alt="On the night" src="http://www.whatisnext.co.uk/ecc/photos/assets/2005-08-17-00-37-52.jpg" width="640" height="480" />';
...
<div id="Wrapper" class="Relative">
	...
	<div id="Document">
		...
		<div id="DocumentContent">
			...
			<p id="GalleryPath"><a href="<?= $blogrelurl ?>">E.C.C Tours of Duty</a> > <a href="<?= $galleryurl ?>"><?= $gallerytitle ?></a> > <a href="<?= $galleryurl ?>gallery/">Gallery</a> > On the night</p>  
			
			<div id="Photo"><img alt="On the night" src="http://www.whatisnext.co.uk/ecc/photos/assets/2005-08-17-00-37-52.jpg" width="640" height="480" /></div>
