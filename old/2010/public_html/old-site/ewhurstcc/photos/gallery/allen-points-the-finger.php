...
include ($_SERVER['DOCUMENT_ROOT']."/ecc/photos//galleryinfo.php");
  ...
  $section = "photosolo";
  $pgtitle = "Allen points the finger";
  $entryid = 464;
  $img = '<img alt="Allen points the finger" src="http://www.whatisnext.co.uk/ecc/photos/assets/2004-08-12-22-16-03.jpg" width="640" height="480" />';
...
<div id="Wrapper" class="Relative">
	...
	<div id="Document">
		...
		<div id="DocumentContent">
			...
			<p id="GalleryPath"><a href="<?= $blogrelurl ?>">E.C.C Tours of Duty</a> > <a href="<?= $galleryurl ?>"><?= $gallerytitle ?></a> > <a href="<?= $galleryurl ?>gallery/">Gallery</a> > Allen points the finger</p>  
			
			<div id="Photo"><img alt="Allen points the finger" src="http://www.whatisnext.co.uk/ecc/photos/assets/2004-08-12-22-16-03.jpg" width="640" height="480" /></div>
			...
			<div id="PhotoMeta">
				<ul>
					...
					<li class="date">12 August 2004</li>
