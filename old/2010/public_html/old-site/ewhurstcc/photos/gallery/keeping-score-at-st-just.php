<?php
  ...
  $section = "photosolo";
  $pgtitle = "Keeping score at St Just";
  $entryid = 320;
  $img = '<img alt="Keeping score at St Just" src="http://www.whatisnext.co.uk/ecc/photosassets/2005-08-16-17-44-46.jpg" width="640" height="480" />';
  $opencomments = true;
...
<div id="desc">
  <h1>Keeping score at St Just</h1>
  <p>Thirst work keeping score</p>
</div>
...
<form method="post" action="http://www.whatisnext.co.uk/cgi-bin/mt/mt-comments.cgi" onsubmit="if (this.bakecookie[0].checked) rememberMe(this)" id="comments-form">
  ...
  <tr valign="top" align="left">
    ...
    <input type="hidden" name="entry_id" value="320" /></td>
  </tr>
...
<p id="path"><a href="<?= $blogrelurl ?>">E.C.C Tours of Duty</a> > <a href="<?= $galleryurl ?>"><?= $gallerytitle ?></a> > <a href="<?= $galleryurl ?>gallery/">Gallery</a> > Keeping score at St Just</p>
