...
include ($_SERVER['DOCUMENT_ROOT']."/ecc/photos//galleryinfo.php");
  ...
  $section = "photosolo";
  $pgtitle = "Jez vs Truro";
  $entryid = 515;
  $img = '<img alt="Jez vs Truro" src="http://www.whatisnext.co.uk/ecc/photos/assets/2005-08-17-15-30-02.jpg" width="640" height="480" />';
...
<div id="Wrapper" class="Relative">
	...
	<div id="Document">
		...
		<div id="DocumentContent">
			...
			<p id="GalleryPath"><a href="<?= $blogrelurl ?>">E.C.C Tours of Duty</a> > <a href="<?= $galleryurl ?>"><?= $gallerytitle ?></a> > <a href="<?= $galleryurl ?>gallery/">Gallery</a> > Jez vs Truro</p>  
			
			<div id="Photo"><img alt="Jez vs Truro" src="http://www.whatisnext.co.uk/ecc/photos/assets/2005-08-17-15-30-02.jpg" width="640" height="480" /></div>
