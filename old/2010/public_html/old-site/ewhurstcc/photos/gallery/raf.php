...
include ($_SERVER['DOCUMENT_ROOT']."/ecc/photos//galleryinfo.php");
  ...
  $pgtitle = "R.A.F.";
  $entryid = 418;
  $img = '<img alt="R.A.F." src="http://www.whatisnext.co.uk/ecc/photos/assets/2003-09-28-00-42-35.jpg" width="640" height="480" />';
...
<div id="Wrapper" class="Relative">
	...
	<div id="Document">
		...
		<div id="DocumentContent">
			...
			<p id="GalleryPath"><a href="<?= $blogrelurl ?>">E.C.C Tours of Duty</a> > <a href="<?= $galleryurl ?>"><?= $gallerytitle ?></a> > <a href="<?= $galleryurl ?>gallery/">Gallery</a> > R.A.F.</p>  
			
			<div id="Photo"><img alt="R.A.F." src="http://www.whatisnext.co.uk/ecc/photos/assets/2003-09-28-00-42-35.jpg" width="640" height="480" /></div>
