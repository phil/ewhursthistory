<?php
  ...
  $section = "photosolo";
  $pgtitle = "James, a phone, and another oppertunity to bundle";
  $entryid = 361;
  $img = '<img alt="James, a phone, and another oppertunity to bundle" src="http://www.whatisnext.co.uk/ecc/photosassets/2005-08-18-02-27-47.jpg" width="640" height="480" />';
  $opencomments = true;
...
<div id="desc">
  <h1>James, a phone, and another oppertunity to bundle</h1>
...
<form method="post" action="http://www.whatisnext.co.uk/cgi-bin/mt/mt-comments.cgi" onsubmit="if (this.bakecookie[0].checked) rememberMe(this)" id="comments-form">
  ...
  <tr valign="top" align="left">
    ...
    <input type="hidden" name="entry_id" value="361" /></td>
  </tr>
...
<p id="path"><a href="<?= $blogrelurl ?>">E.C.C Tours of Duty</a> > <a href="<?= $galleryurl ?>"><?= $gallerytitle ?></a> > <a href="<?= $galleryurl ?>gallery/">Gallery</a> > James, a phone, and another oppertunity to bundle</p>
