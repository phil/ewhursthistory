...
include ($_SERVER['DOCUMENT_ROOT']."/ecc/photos//galleryinfo.php");
  ...
  $section = "photosolo";
  $pgtitle = "Catching up on some sleep";
  $entryid = 517;
  $img = '<img alt="Catching up on some sleep" src="http://www.whatisnext.co.uk/ecc/photos/assets/2005-08-17-15-46-06.jpg" width="640" height="480" />';
...
<div id="Wrapper" class="Relative">
	...
	<div id="Document">
		...
		<div id="DocumentContent">
			...
			<p id="GalleryPath"><a href="<?= $blogrelurl ?>">E.C.C Tours of Duty</a> > <a href="<?= $galleryurl ?>"><?= $gallerytitle ?></a> > <a href="<?= $galleryurl ?>gallery/">Gallery</a> > Catching up on some sleep</p>  
			
			<div id="Photo"><img alt="Catching up on some sleep" src="http://www.whatisnext.co.uk/ecc/photos/assets/2005-08-17-15-46-06.jpg" width="640" height="480" /></div>
