...
include ($_SERVER['DOCUMENT_ROOT']."/ecc/photos//galleryinfo.php");
  ...
  $pgtitle = "Smile";
  $entryid = 545;
  $img = '<img alt="Smile" src="http://www.whatisnext.co.uk/ecc/photos/assets/2005-08-23-11-28-40.jpg" width="480" height="640" />';
...
<div id="Wrapper" class="Relative">
	...
	<div id="Document">
		...
		<div id="DocumentContent">
			...
			<p id="GalleryPath"><a href="<?= $blogrelurl ?>">E.C.C Tours of Duty</a> > <a href="<?= $galleryurl ?>"><?= $gallerytitle ?></a> > <a href="<?= $galleryurl ?>gallery/">Gallery</a> > Smile</p>  
			
			<div id="Photo"><img alt="Smile" src="http://www.whatisnext.co.uk/ecc/photos/assets/2005-08-23-11-28-40.jpg" width="480" height="640" /></div>
			...
			<div id="PhotoMeta">
				<ul>
					...
					<li class="date">23 August 2005</li>
