<?php
  ...
  $section = "photosolo";
  $pgtitle = "Next Moring, Thats more like it";
  $entryid = 263;
  $img = '<img alt="Next Moring, Thats more like it" src="http://www.whatisnext.co.uk/ecc/photosassets/2004-08-10-08-54-33.jpg" width="640" height="480" />';
  $opencomments = true;
...
<div id="desc">
  <h1>Next Moring, Thats more like it</h1>
...
<div id="main">
  ...
  <div id="meta">
    <ul>
      ...
      <li class="date">10 August 2004</li>
...
<form method="post" action="http://www.whatisnext.co.uk/cgi-bin/mt/mt-comments.cgi" onsubmit="if (this.bakecookie[0].checked) rememberMe(this)" id="comments-form">
  ...
  <tr valign="top" align="left">
    ...
    <input type="hidden" name="entry_id" value="263" /></td>
  </tr>
...
<p id="path"><a href="<?= $blogrelurl ?>">E.C.C Tours of Duty</a> > <a href="<?= $galleryurl ?>"><?= $gallerytitle ?></a> > <a href="<?= $galleryurl ?>gallery/">Gallery</a> > Next Moring, Thats more like it</p>
