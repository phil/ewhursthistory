<?php
  ...
  $section = "photosolo";
  $pgtitle = "Getting Squashed";
  $entryid = 340;
  $img = '<img alt="Getting Squashed" src="http://www.whatisnext.co.uk/ecc/photosassets/2005-08-18-01-39-22.jpg" width="640" height="480" />';
  $opencomments = true;
...
<div id="desc">
  <h1>Getting Squashed</h1>
  <p>He looks like hes in pain?</p>
</div>
...
<form method="post" action="http://www.whatisnext.co.uk/cgi-bin/mt/mt-comments.cgi" onsubmit="if (this.bakecookie[0].checked) rememberMe(this)" id="comments-form">
  ...
  <tr valign="top" align="left">
    ...
    <input type="hidden" name="entry_id" value="340" /></td>
  </tr>
...
<p id="path"><a href="<?= $blogrelurl ?>">E.C.C Tours of Duty</a> > <a href="<?= $galleryurl ?>"><?= $gallerytitle ?></a> > <a href="<?= $galleryurl ?>gallery/">Gallery</a> > Getting Squashed</p>
