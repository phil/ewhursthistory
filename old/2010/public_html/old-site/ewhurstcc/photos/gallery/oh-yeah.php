...
include ($_SERVER['DOCUMENT_ROOT']."/ecc/photos//galleryinfo.php");
  ...
  $pgtitle = "Oh Yeah";
  $entryid = 506;
  $img = '<img alt="Oh Yeah" src="http://www.whatisnext.co.uk/ecc/photos/assets/2005-08-16-23-52-22.jpg" width="640" height="480" />';
...
<div id="Wrapper" class="Relative">
	...
	<div id="Document">
		...
		<div id="DocumentContent">
			...
			<p id="GalleryPath"><a href="<?= $blogrelurl ?>">E.C.C Tours of Duty</a> > <a href="<?= $galleryurl ?>"><?= $gallerytitle ?></a> > <a href="<?= $galleryurl ?>gallery/">Gallery</a> > Oh Yeah</p>  
			
			<div id="Photo"><img alt="Oh Yeah" src="http://www.whatisnext.co.uk/ecc/photos/assets/2005-08-16-23-52-22.jpg" width="640" height="480" /></div>
