...
include ($_SERVER['DOCUMENT_ROOT']."/ecc/photos//galleryinfo.php");
  ...
  $section = "photosolo";
  $pgtitle = "Matt gets some beans";
  $entryid = 456;
  $img = '<img alt="Matt gets some beans" src="http://www.whatisnext.co.uk/ecc/photos/assets/2003-09-29-22-15-13.jpg" width="640" height="480" />';
...
<div id="Wrapper" class="Relative">
	...
	<div id="Document">
		...
		<div id="DocumentContent">
			...
			<p id="GalleryPath"><a href="<?= $blogrelurl ?>">E.C.C Tours of Duty</a> > <a href="<?= $galleryurl ?>"><?= $gallerytitle ?></a> > <a href="<?= $galleryurl ?>gallery/">Gallery</a> > Matt gets some beans</p>  
			
			<div id="Photo"><img alt="Matt gets some beans" src="http://www.whatisnext.co.uk/ecc/photos/assets/2003-09-29-22-15-13.jpg" width="640" height="480" /></div>
			
			<div id="PhotoInfo">
				<h1>E.C.C Tours of Duty</h1>
				<p>Parry, wasn&#8217;t even drunk yet?&#xa;</p>
			</div>
			<div id="PhotoMeta">
				<ul>
