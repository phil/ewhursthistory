<?php
  ...
  $section = "photosolo";
  $pgtitle = "More childish behaviour";
  $entryid = 367;
  $img = '<img alt="More childish behaviour" src="http://www.whatisnext.co.uk/ecc/photosassets/2005-08-18-02-37-02.jpg" width="640" height="480" />';
  $opencomments = true;
...
<form method="post" action="http://www.whatisnext.co.uk/cgi-bin/mt/mt-comments.cgi" onsubmit="if (this.bakecookie[0].checked) rememberMe(this)" id="comments-form">
  ...
  <tr valign="top" align="left">
    ...
    <input type="hidden" name="entry_id" value="367" /></td>
  </tr>
...
<p id="path"><a href="<?= $blogrelurl ?>">E.C.C Tours of Duty</a> > <a href="<?= $galleryurl ?>"><?= $gallerytitle ?></a> > <a href="<?= $galleryurl ?>gallery/">Gallery</a> > More childish behaviour</p>
