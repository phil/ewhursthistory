<?php
  ...
  $pgtitle = "Kabab Time";
  $entryid = 272;
  $img = '<img alt="Kabab Time" src="http://www.whatisnext.co.uk/ecc/photosassets/2004-08-11-01-10-33.jpg" width="640" height="480" />';
  $opencomments = true;
...
<div id="desc">
  <h1>Kabab Time</h1>
  <p>Gibbo (leopard skin), Skipper</p>
</div>
...
<div id="main">
  ...
  <div id="meta">
    <ul>
      ...
      <li class="date">11 August 2004</li>
...
<form method="post" action="http://www.whatisnext.co.uk/cgi-bin/mt/mt-comments.cgi" onsubmit="if (this.bakecookie[0].checked) rememberMe(this)" id="comments-form">
  ...
  <tr valign="top" align="left">
    ...
    <input type="hidden" name="entry_id" value="272" /></td>
  </tr>
...
<p id="path"><a href="<?= $blogrelurl ?>">E.C.C Tours of Duty</a> > <a href="<?= $galleryurl ?>"><?= $gallerytitle ?></a> > <a href="<?= $galleryurl ?>gallery/">Gallery</a> > Kabab Time</p>
