...
include ($_SERVER['DOCUMENT_ROOT']."/ecc/photos//galleryinfo.php");
  ...
  $section = "photosolo";
  $pgtitle = "Cations escape attempts";
  $entryid = 447;
  $img = '<img alt="Cations escape attempts" src="http://www.whatisnext.co.uk/ecc/photos/assets/2003-09-28-23-49-55.jpg" width="480" height="640" />';
...
<div id="Wrapper" class="Relative">
	...
	<div id="Document">
		...
		<div id="DocumentContent">
			...
			<p id="GalleryPath"><a href="<?= $blogrelurl ?>">E.C.C Tours of Duty</a> > <a href="<?= $galleryurl ?>"><?= $gallerytitle ?></a> > <a href="<?= $galleryurl ?>gallery/">Gallery</a> > Cations escape attempts</p>  
			
			<div id="Photo"><img alt="Cations escape attempts" src="http://www.whatisnext.co.uk/ecc/photos/assets/2003-09-28-23-49-55.jpg" width="480" height="640" /></div>
