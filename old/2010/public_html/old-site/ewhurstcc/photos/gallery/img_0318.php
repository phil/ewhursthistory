...
include ($_SERVER['DOCUMENT_ROOT']."/ecc/photos//galleryinfo.php");
  ...
  $pgtitle = "IMG_0318";
  $entryid = 434;
  $img = '<img alt="IMG_0318" src="http://www.whatisnext.co.uk/ecc/photos/assets/2003-09-28-02-54-36.jpg" width="480" height="640" />';
...
<div id="Wrapper" class="Relative">
	...
	<div id="Document">
		...
		<div id="DocumentContent">
			...
			<p id="GalleryPath"><a href="<?= $blogrelurl ?>">E.C.C Tours of Duty</a> > <a href="<?= $galleryurl ?>"><?= $gallerytitle ?></a> > <a href="<?= $galleryurl ?>gallery/">Gallery</a> > IMG_0318</p>  
			
			<div id="Photo"><img alt="IMG_0318" src="http://www.whatisnext.co.uk/ecc/photos/assets/2003-09-28-02-54-36.jpg" width="480" height="640" /></div>
