...
include ($_SERVER['DOCUMENT_ROOT']."/ecc/photos//galleryinfo.php");
  ...
  $section = "photosolo";
  $pgtitle = "One of them has had too much to drink";
  $entryid = 471;
  $img = '<img alt="One of them has had too much to drink" src="http://www.whatisnext.co.uk/ecc/photos/assets/2004-08-13-00-59-59.jpg" width="640" height="480" />';
...
<div id="Wrapper" class="Relative">
	...
	<div id="Document">
		...
		<div id="DocumentContent">
			...
			<p id="GalleryPath"><a href="<?= $blogrelurl ?>">E.C.C Tours of Duty</a> > <a href="<?= $galleryurl ?>"><?= $gallerytitle ?></a> > <a href="<?= $galleryurl ?>gallery/">Gallery</a> > One of them has had too much to drink</p>  
			
			<div id="Photo"><img alt="One of them has had too much to drink" src="http://www.whatisnext.co.uk/ecc/photos/assets/2004-08-13-00-59-59.jpg" width="640" height="480" /></div>
