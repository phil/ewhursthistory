...
include ($_SERVER['DOCUMENT_ROOT']."/ecc/photos//galleryinfo.php");
  ...
  $pgtitle = "camouflage";
  $entryid = 512;
  $img = '<img alt="camouflage" src="http://www.whatisnext.co.uk/ecc/photos/assets/2005-08-17-15-01-32.jpg" width="640" height="480" />';
...
<div id="Wrapper" class="Relative">
	...
	<div id="Document">
		...
		<div id="DocumentContent">
			...
			<p id="GalleryPath"><a href="<?= $blogrelurl ?>">E.C.C Tours of Duty</a> > <a href="<?= $galleryurl ?>"><?= $gallerytitle ?></a> > <a href="<?= $galleryurl ?>gallery/">Gallery</a> > camouflage</p>  
			
			<div id="Photo"><img alt="camouflage" src="http://www.whatisnext.co.uk/ecc/photos/assets/2005-08-17-15-01-32.jpg" width="640" height="480" /></div>
