<?php
  ...
  $section = "photosolo";
  $pgtitle = "Robby recovering the next day";
  $entryid = 382;
  $img = '<img alt="Robby recovering the next day" src="http://www.whatisnext.co.uk/ecc/photosassets/2005-08-18-11-47-51.jpg" width="480" height="640" />';
  $opencomments = true;
...
<div id="desc">
  <h1>Robby recovering the next day</h1>
...
<form method="post" action="http://www.whatisnext.co.uk/cgi-bin/mt/mt-comments.cgi" onsubmit="if (this.bakecookie[0].checked) rememberMe(this)" id="comments-form">
  ...
  <tr valign="top" align="left">
    ...
    <input type="hidden" name="entry_id" value="382" /></td>
  </tr>
...
<p id="path"><a href="<?= $blogrelurl ?>">E.C.C Tours of Duty</a> > <a href="<?= $galleryurl ?>"><?= $gallerytitle ?></a> > <a href="<?= $galleryurl ?>gallery/">Gallery</a> > Robby recovering the next day</p>
