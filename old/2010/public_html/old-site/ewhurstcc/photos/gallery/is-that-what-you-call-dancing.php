<?php
  ...
  $section = "photosolo";
  $pgtitle = "Is that what you call dancing?";
  $entryid = 402;
  $img = '<img alt="Is that what you call dancing?" src="http://www.whatisnext.co.uk/ecc/photosassets/2005-08-19-01-48-49.jpg" width="640" height="480" />';
  $opencomments = true;
...
<div id="desc">
  <h1>Is that what you call dancing?</h1>
  <p>Alex doesn&#8217;t think so. STOP, its hold up</p>
</div>
...
<form method="post" action="http://www.whatisnext.co.uk/cgi-bin/mt/mt-comments.cgi" onsubmit="if (this.bakecookie[0].checked) rememberMe(this)" id="comments-form">
  ...
  <tr valign="top" align="left">
    ...
    <input type="hidden" name="entry_id" value="402" /></td>
  </tr>
...
<p id="path"><a href="<?= $blogrelurl ?>">E.C.C Tours of Duty</a> > <a href="<?= $galleryurl ?>"><?= $gallerytitle ?></a> > <a href="<?= $galleryurl ?>gallery/">Gallery</a> > Is that what you call dancing?</p>
