<?php
  ...
  $section = "photosolo";
  $pgtitle = "Oooh, i didn&#8217;t notice that!";
  $entryid = 342;
  $img = '<img alt="Oooh, i didn\'t notice that!" src="http://www.whatisnext.co.uk/ecc/photosassets/2005-08-18-01-56-29.jpg" width="640" height="480" />';
  $opencomments = true;
...
<div id="desc">
  <h1>Oooh, i didn&#8217;t notice that!</h1>
  <p>Ooh, look aftershock!</p>
</div>
...
<form method="post" action="http://www.whatisnext.co.uk/cgi-bin/mt/mt-comments.cgi" onsubmit="if (this.bakecookie[0].checked) rememberMe(this)" id="comments-form">
  ...
  <tr valign="top" align="left">
    ...
    <input type="hidden" name="entry_id" value="342" /></td>
  </tr>
...
<p id="path"><a href="<?= $blogrelurl ?>">E.C.C Tours of Duty</a> > <a href="<?= $galleryurl ?>"><?= $gallerytitle ?></a> > <a href="<?= $galleryurl ?>gallery/">Gallery</a> > Oooh, i didn&#8217;t notice that!</p>
