...
include ($_SERVER['DOCUMENT_ROOT']."/ecc/photos//galleryinfo.php");
  ...
  $pgtitle = "IMG_0306";
  $entryid = 428;
  $img = '<img alt="IMG_0306" src="http://www.whatisnext.co.uk/ecc/photos/assets/2003-09-28-01-49-07.jpg" width="480" height="640" />';
...
<div id="Wrapper" class="Relative">
	...
	<div id="Document">
		...
		<div id="DocumentContent">
			...
			<p id="GalleryPath"><a href="<?= $blogrelurl ?>">E.C.C Tours of Duty</a> > <a href="<?= $galleryurl ?>"><?= $gallerytitle ?></a> > <a href="<?= $galleryurl ?>gallery/">Gallery</a> > IMG_0306</p>  
			
			<div id="Photo"><img alt="IMG_0306" src="http://www.whatisnext.co.uk/ecc/photos/assets/2003-09-28-01-49-07.jpg" width="480" height="640" /></div>
