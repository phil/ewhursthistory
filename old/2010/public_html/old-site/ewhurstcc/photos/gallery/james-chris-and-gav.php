<?php
  ...
  $section = "photosolo";
  $pgtitle = "James, Chris and Gav";
  $entryid = 353;
  $img = '<img alt="James, Chris and Gav" src="http://www.whatisnext.co.uk/ecc/photosassets/2005-08-18-02-18-30.jpg" width="480" height="640" />';
  $opencomments = true;
...
<div id="desc">
  <h1>James, Chris and Gav</h1>
  <p>The walk back to the hotel was like one big game of rugby</p>
</div>
...
<form method="post" action="http://www.whatisnext.co.uk/cgi-bin/mt/mt-comments.cgi" onsubmit="if (this.bakecookie[0].checked) rememberMe(this)" id="comments-form">
  ...
  <tr valign="top" align="left">
    ...
    <input type="hidden" name="entry_id" value="353" /></td>
  </tr>
...
<p id="path"><a href="<?= $blogrelurl ?>">E.C.C Tours of Duty</a> > <a href="<?= $galleryurl ?>"><?= $gallerytitle ?></a> > <a href="<?= $galleryurl ?>gallery/">Gallery</a> > James, Chris and Gav</p>
