<?php
  ...
  $section = "photosolo";
  $pgtitle = "As wee leave, the weather turns";
  $entryid = 317;
  $img = '<img alt="As wee leave, the weather turns" src="http://www.whatisnext.co.uk/ecc/photosassets/2004-08-13-17-49-44.jpg" width="640" height="480" />';
  $opencomments = true;
...
<div id="desc">
  <h1>As wee leave, the weather turns</h1>
...
<form method="post" action="http://www.whatisnext.co.uk/cgi-bin/mt/mt-comments.cgi" onsubmit="if (this.bakecookie[0].checked) rememberMe(this)" id="comments-form">
  ...
  <tr valign="top" align="left">
    ...
    <input type="hidden" name="entry_id" value="317" /></td>
  </tr>
...
<p id="path"><a href="<?= $blogrelurl ?>">E.C.C Tours of Duty</a> > <a href="<?= $galleryurl ?>"><?= $gallerytitle ?></a> > <a href="<?= $galleryurl ?>gallery/">Gallery</a> > As wee leave, the weather turns</p>
