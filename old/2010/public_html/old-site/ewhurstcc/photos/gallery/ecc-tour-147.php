<?php
  ...
  $section = "photosolo";
  $pgtitle = "ecc Tour 147";
  $entryid = 295;
  $img = '<img alt="ecc Tour 147" src="http://www.whatisnext.co.uk/ecc/photosassets/2004-08-13-01-56-36.jpg" width="640" height="480" />';
  $opencomments = true;
...
<form method="post" action="http://www.whatisnext.co.uk/cgi-bin/mt/mt-comments.cgi" onsubmit="if (this.bakecookie[0].checked) rememberMe(this)" id="comments-form">
  ...
  <tr valign="top" align="left">
    ...
    <input type="hidden" name="entry_id" value="295" /></td>
  </tr>
...
<p id="path"><a href="<?= $blogrelurl ?>">E.C.C Tours of Duty</a> > <a href="<?= $galleryurl ?>"><?= $gallerytitle ?></a> > <a href="<?= $galleryurl ?>gallery/">Gallery</a> > ecc Tour 147</p>
