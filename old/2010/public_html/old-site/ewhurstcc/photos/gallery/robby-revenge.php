<?php
  ...
  $section = "photosolo";
  $pgtitle = "Robby, revenge";
  $entryid = 372;
  $img = '<img alt="Robby, revenge" src="http://www.whatisnext.co.uk/ecc/photosassets/2005-08-18-02-46-38.jpg" width="480" height="640" />';
  $opencomments = true;
...
<div id="desc">
  <h1>Robby, revenge</h1>
  <p>Parry has just sprayed bear all over Rob, and he wants revenge</p>
</div>
...
<form method="post" action="http://www.whatisnext.co.uk/cgi-bin/mt/mt-comments.cgi" onsubmit="if (this.bakecookie[0].checked) rememberMe(this)" id="comments-form">
  ...
  <tr valign="top" align="left">
    ...
    <input type="hidden" name="entry_id" value="372" /></td>
  </tr>
...
<p id="path"><a href="<?= $blogrelurl ?>">E.C.C Tours of Duty</a> > <a href="<?= $galleryurl ?>"><?= $gallerytitle ?></a> > <a href="<?= $galleryurl ?>gallery/">Gallery</a> > Robby, revenge</p>
