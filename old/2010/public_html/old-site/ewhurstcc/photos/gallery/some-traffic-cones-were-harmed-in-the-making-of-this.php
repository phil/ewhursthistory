<?php
  ...
  $section = "photosolo";
  $pgtitle = "Some traffic cones were harmed in the making of this";
  $entryid = 357;
  $img = '<img alt="Some traffic cones were harmed in the making of this" src="http://www.whatisnext.co.uk/ecc/photosassets/2005-08-18-02-23-12.jpg" width="480" height="640" />';
  $opencomments = true;
...
<div id="desc">
  <h1>Some traffic cones were harmed in the making of this</h1>
...
<form method="post" action="http://www.whatisnext.co.uk/cgi-bin/mt/mt-comments.cgi" onsubmit="if (this.bakecookie[0].checked) rememberMe(this)" id="comments-form">
  ...
  <tr valign="top" align="left">
    ...
    <input type="hidden" name="entry_id" value="357" /></td>
  </tr>
...
<p id="path"><a href="<?= $blogrelurl ?>">E.C.C Tours of Duty</a> > <a href="<?= $galleryurl ?>"><?= $gallerytitle ?></a> > <a href="<?= $galleryurl ?>gallery/">Gallery</a> > Some traffic cones were harmed in the making of this</p>
