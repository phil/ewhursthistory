...
include ($_SERVER['DOCUMENT_ROOT']."/ecc/photos//galleryinfo.php");
  ...
  $section = "photosolo";
  $pgtitle = "Its all in the preperation";
  $entryid = 421;
  $img = '<img alt="Its all in the preperation" src="http://www.whatisnext.co.uk/ecc/photos/assets/2003-09-28-00-50-00.jpg" width="480" height="640" />';
...
<div id="Wrapper" class="Relative">
	...
	<div id="Document">
		...
		<div id="DocumentContent">
			...
			<p id="GalleryPath"><a href="<?= $blogrelurl ?>">E.C.C Tours of Duty</a> > <a href="<?= $galleryurl ?>"><?= $gallerytitle ?></a> > <a href="<?= $galleryurl ?>gallery/">Gallery</a> > Its all in the preperation</p>  
			
			<div id="Photo"><img alt="Its all in the preperation" src="http://www.whatisnext.co.uk/ecc/photos/assets/2003-09-28-00-50-00.jpg" width="480" height="640" /></div>
			...
			<div id="PhotoMeta">
				<ul>
					...
					<li class="date">28 September 2003</li>
