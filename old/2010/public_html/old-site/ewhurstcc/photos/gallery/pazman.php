...
include ($_SERVER['DOCUMENT_ROOT']."/ecc/photos//galleryinfo.php");
  ...
  $pgtitle = "Paz-man";
  $entryid = 466;
  $img = '<img alt="Paz-man" src="http://www.whatisnext.co.uk/ecc/photos/assets/2004-08-12-22-16-59.jpg" width="640" height="480" />';
...
<div id="Wrapper" class="Relative">
	...
	<div id="Document">
		...
		<div id="DocumentContent">
			...
			<p id="GalleryPath"><a href="<?= $blogrelurl ?>">E.C.C Tours of Duty</a> > <a href="<?= $galleryurl ?>"><?= $gallerytitle ?></a> > <a href="<?= $galleryurl ?>gallery/">Gallery</a> > Paz-man</p>  
			
			<div id="Photo"><img alt="Paz-man" src="http://www.whatisnext.co.uk/ecc/photos/assets/2004-08-12-22-16-59.jpg" width="640" height="480" /></div>
