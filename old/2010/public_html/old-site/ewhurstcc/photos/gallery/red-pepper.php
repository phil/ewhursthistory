...
include ($_SERVER['DOCUMENT_ROOT']."/ecc/photos//galleryinfo.php");
  ...
  $pgtitle = "Red Pepper?";
  $entryid = 455;
  $img = '<img alt="Red Pepper?" src="http://www.whatisnext.co.uk/ecc/photos/assets/2003-09-29-22-11-57.jpg" width="480" height="640" />';
...
<div id="Wrapper" class="Relative">
	...
	<div id="Document">
		...
		<div id="DocumentContent">
			...
			<p id="GalleryPath"><a href="<?= $blogrelurl ?>">E.C.C Tours of Duty</a> > <a href="<?= $galleryurl ?>"><?= $gallerytitle ?></a> > <a href="<?= $galleryurl ?>gallery/">Gallery</a> > Red Pepper?</p>  
			
			<div id="Photo"><img alt="Red Pepper?" src="http://www.whatisnext.co.uk/ecc/photos/assets/2003-09-29-22-11-57.jpg" width="480" height="640" /></div>
