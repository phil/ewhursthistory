<?php
  ...
  $section = "photosolo";
  $pgtitle = "Serious Drinking";
  $entryid = 398;
  $img = '<img alt="Serious Drinking" src="http://www.whatisnext.co.uk/ecc/photosassets/2005-08-19-00-56-20.jpg" width="640" height="480" />';
  $opencomments = true;
...
<div id="desc">
  <h1>Serious Drinking</h1>
  <p>Those are Quad shots of all the aftershocks! Red, Green, Blue and Black! Whoo was sleeping in parries room&#xa;</p>
</div>
...
<form method="post" action="http://www.whatisnext.co.uk/cgi-bin/mt/mt-comments.cgi" onsubmit="if (this.bakecookie[0].checked) rememberMe(this)" id="comments-form">
  ...
  <tr valign="top" align="left">
    ...
    <input type="hidden" name="entry_id" value="398" /></td>
  </tr>
...
<p id="path"><a href="<?= $blogrelurl ?>">E.C.C Tours of Duty</a> > <a href="<?= $galleryurl ?>"><?= $gallerytitle ?></a> > <a href="<?= $galleryurl ?>gallery/">Gallery</a> > Serious Drinking</p>
