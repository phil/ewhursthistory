<?php
  ...
  $pgtitle = "Practice";
  $entryid = 265;
  $img = '<img alt="Practice" src="http://www.whatisnext.co.uk/ecc/photosassets/2004-08-10-14-30-45.jpg" width="640" height="480" />';
  $opencomments = true;
...
<div id="desc">
  <h1>Practice</h1>
  <p>Chris shows Trev and Parru his swing</p>
</div>
...
<form method="post" action="http://www.whatisnext.co.uk/cgi-bin/mt/mt-comments.cgi" onsubmit="if (this.bakecookie[0].checked) rememberMe(this)" id="comments-form">
  ...
  <tr valign="top" align="left">
    ...
    <input type="hidden" name="entry_id" value="265" /></td>
  </tr>
...
<p id="path"><a href="<?= $blogrelurl ?>">E.C.C Tours of Duty</a> > <a href="<?= $galleryurl ?>"><?= $gallerytitle ?></a> > <a href="<?= $galleryurl ?>gallery/">Gallery</a> > Practice</p>
