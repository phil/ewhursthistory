<?php
  ...
  $section = "photosolo";
  $pgtitle = "Best of Friends";
  $entryid = 314;
  $img = '<img alt="Best of Friends" src="http://www.whatisnext.co.uk/ecc/photosassets/2004-08-13-02-43-31.jpg" width="640" height="480" />';
  $opencomments = true;
...
<form method="post" action="http://www.whatisnext.co.uk/cgi-bin/mt/mt-comments.cgi" onsubmit="if (this.bakecookie[0].checked) rememberMe(this)" id="comments-form">
  ...
  <tr valign="top" align="left">
    ...
    <input type="hidden" name="entry_id" value="314" /></td>
  </tr>
...
<p id="path"><a href="<?= $blogrelurl ?>">E.C.C Tours of Duty</a> > <a href="<?= $galleryurl ?>"><?= $gallerytitle ?></a> > <a href="<?= $galleryurl ?>gallery/">Gallery</a> > Best of Friends</p>
