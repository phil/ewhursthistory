<?php
  ...
  $section = "photosolo";
  $pgtitle = "Bowling attack";
  $entryid = 301;
  $img = '<img alt="Bowling attack" src="http://www.whatisnext.co.uk/ecc/photosassets/2004-08-13-02-07-38.jpg" width="640" height="480" />';
  $opencomments = true;
...
<div id="desc">
  <h1>Bowling attack</h1>
  <p>Well, some of the any way.&#xa;Gibbo, Creed, Gav, James, Jez</p>
</div>
...
<form method="post" action="http://www.whatisnext.co.uk/cgi-bin/mt/mt-comments.cgi" onsubmit="if (this.bakecookie[0].checked) rememberMe(this)" id="comments-form">
  ...
  <tr valign="top" align="left">
    ...
    <input type="hidden" name="entry_id" value="301" /></td>
  </tr>
...
<p id="path"><a href="<?= $blogrelurl ?>">E.C.C Tours of Duty</a> > <a href="<?= $galleryurl ?>"><?= $gallerytitle ?></a> > <a href="<?= $galleryurl ?>gallery/">Gallery</a> > Bowling attack</p>
