<?php
  ...
  $section = "photosolo";
  $pgtitle = "Getting Back Home";
  $entryid = 252;
  $img = '<img alt="Getting Back Home" src="http://www.whatisnext.co.uk/ecc/photosassets/2003-07-25-13-30-00.jpg" width="638" height="367" />';
  $opencomments = true;
...
<form method="post" action="http://www.whatisnext.co.uk/cgi-bin/mt/mt-comments.cgi" onsubmit="if (this.bakecookie[0].checked) rememberMe(this)" id="comments-form">
  ...
  <tr valign="top" align="left">
    ...
    <input type="hidden" name="entry_id" value="252" /></td>
  </tr>
...
<p id="path"><a href="<?= $blogrelurl ?>">E.C.C Tours of Duty</a> > <a href="<?= $galleryurl ?>"><?= $gallerytitle ?></a> > <a href="<?= $galleryurl ?>gallery/">Gallery</a> > Getting Back Home</p>
