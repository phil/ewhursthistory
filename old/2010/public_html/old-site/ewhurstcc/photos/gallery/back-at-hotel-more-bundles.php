<?php
  ...
  $section = "photosolo";
  $pgtitle = "Back at hotel, more bundles";
  $entryid = 370;
  $img = '<img alt="Back at hotel, more bundles" src="http://www.whatisnext.co.uk/ecc/photosassets/2005-08-18-02-43-06.jpg" width="640" height="480" />';
  $opencomments = true;
...
<div id="desc">
  <h1>Back at hotel, more bundles</h1>
  <p>24 Hour Bar, need any more excuses?</p>
</div>
...
<form method="post" action="http://www.whatisnext.co.uk/cgi-bin/mt/mt-comments.cgi" onsubmit="if (this.bakecookie[0].checked) rememberMe(this)" id="comments-form">
  ...
  <tr valign="top" align="left">
    ...
    <input type="hidden" name="entry_id" value="370" /></td>
  </tr>
...
<p id="path"><a href="<?= $blogrelurl ?>">E.C.C Tours of Duty</a> > <a href="<?= $galleryurl ?>"><?= $gallerytitle ?></a> > <a href="<?= $galleryurl ?>gallery/">Gallery</a> > Back at hotel, more bundles</p>
