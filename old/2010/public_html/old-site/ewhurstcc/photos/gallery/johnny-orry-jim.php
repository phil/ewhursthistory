<?php
  ...
  $section = "photosolo";
  $pgtitle = "Johnny, Orry, Jim";
  $entryid = 256;
  $img = '<img alt="Johnny, Orry, Jim" src="http://www.whatisnext.co.uk/ecc/photosassets/2004-08-09-13-58-51.jpg" width="640" height="480" />';
  $opencomments = true;
...
<div id="desc">
  <h1>Johnny, Orry, Jim</h1>
  <p>Not too sure whats going on here? Whatever it is, everyone seem sot be enjoying it</p>
</div>
...
<form method="post" action="http://www.whatisnext.co.uk/cgi-bin/mt/mt-comments.cgi" onsubmit="if (this.bakecookie[0].checked) rememberMe(this)" id="comments-form">
  ...
  <tr valign="top" align="left">
    ...
    <input type="hidden" name="entry_id" value="256" /></td>
  </tr>
...
<p id="path"><a href="<?= $blogrelurl ?>">E.C.C Tours of Duty</a> > <a href="<?= $galleryurl ?>"><?= $gallerytitle ?></a> > <a href="<?= $galleryurl ?>gallery/">Gallery</a> > Johnny, Orry, Jim</p>
