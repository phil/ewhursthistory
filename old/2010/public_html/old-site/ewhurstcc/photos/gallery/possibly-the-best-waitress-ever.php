...
include ($_SERVER['DOCUMENT_ROOT']."/ecc/photos//galleryinfo.php");
  ...
  $section = "photosolo";
  $pgtitle = "Possibly the best waitress ever?";
  $entryid = 459;
  $img = '<img alt="Possibly the best waitress ever?" src="http://www.whatisnext.co.uk/ecc/photos/assets/2003-09-29-22-57-39.jpg" width="640" height="480" />';
...
<div id="Wrapper" class="Relative">
	...
	<div id="Document">
		...
		<div id="DocumentContent">
			...
			<p id="GalleryPath"><a href="<?= $blogrelurl ?>">E.C.C Tours of Duty</a> > <a href="<?= $galleryurl ?>"><?= $gallerytitle ?></a> > <a href="<?= $galleryurl ?>gallery/">Gallery</a> > Possibly the best waitress ever?</p>  
			
			<div id="Photo"><img alt="Possibly the best waitress ever?" src="http://www.whatisnext.co.uk/ecc/photos/assets/2003-09-29-22-57-39.jpg" width="640" height="480" /></div>
			...
			<div id="PhotoMeta">
				<ul>
					...
					<li class="date">29 September 2003</li>
