...
include ($_SERVER['DOCUMENT_ROOT']."/ecc/photos//galleryinfo.php");
  ...
  $section = "photosolo";
  $pgtitle = "Cation vs Truro";
  $entryid = 519;
  $img = '<img alt="Cation vs Truro" src="http://www.whatisnext.co.uk/ecc/photos/assets/2005-08-17-16-18-36.jpg" width="640" height="480" />';
...
<div id="Wrapper" class="Relative">
	...
	<div id="Document">
		...
		<div id="DocumentContent">
			...
			<p id="GalleryPath"><a href="<?= $blogrelurl ?>">E.C.C Tours of Duty</a> > <a href="<?= $galleryurl ?>"><?= $gallerytitle ?></a> > <a href="<?= $galleryurl ?>gallery/">Gallery</a> > Cation vs Truro</p>  
			
			<div id="Photo"><img alt="Cation vs Truro" src="http://www.whatisnext.co.uk/ecc/photos/assets/2005-08-17-16-18-36.jpg" width="640" height="480" /></div>
