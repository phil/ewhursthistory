...
<head>
	...
	<title>Photographics - Stone Wall</title>
...
<body id="body-photos-dark">
	<div id="wrapper">
		...
		<div class="photographic">
			<img src="http://www.whatisnext.co.uk/photographics/photos/motion-stonewall.jpg" alt="Stone Wall" />
		</div>
		...
		<div class="photographic-details">
			...
			<p class="gallery-nav-index">Galleries: <a href="http://www.whatisnext.co.uk/photographics/motion-blurr/">Motion Blurr</a>, </p>
		</div>
