...
6. Restore/uncomment the Mint JavaScript include (including the php_value 
auto_prepend_file line in your .htaccess file if applicable) on your site. The 
path should be updated from /mint/mint.js.php to /mint/?js
