...
<head>
	<title>Journal, May 4th</title>
	<meta http-equiv="Content-Type" content="text/html; charset=iso-8859-1" />
	<meta name="description" content="In tribute to Starwars, Hapy May 4th be with you Day!!&#8230;" />
...
<div class="jounal-navigator">
	...
	<a href="http://www.whatisnext.co.uk/journal/2006/04/styling_the_flickr_badge.php" class="previous-entry">Styling the Flickr Badge</a>
	

	<a href="http://www.whatisnext.co.uk/journal/" class="journal-index">Journal Front Page</a>
	
	
	<a href="http://www.whatisnext.co.uk/journal/2006/06/microsoft_net_frameworks.php" class="next-entry">Microsoft .Net Frameworks</a>
	
</div>    

		<div id="entry-566" class="entry">
					
			<h1>May 4th</h1>
					
			<div class="entry-body">
				<p>In tribute to Starwars, Hapy May 4th be with you Day!!</p>
			</div>
...
<div id="comment-wrapper" class="section-wrapper">
	<div id="comments" class="section">
			...
			<form method="post" action="http://www.whatisnext.co.uk/cgi-bin/mt/mt-comments.cgi" name="comments_form" onsubmit="if (this.bakecookie.checked) rememberMe(this)">
				...
				<input type="hidden" name="entry_id" value="566" />
				...
				<div class="comments-open" id="comments-open">
					...
					<div class="comments-open-content">
						...
						<!--
							writeTypeKeyGreeting(commenter_name, 566);
						//-->
						</script>
