...
<head>
	<title>Journal, Is it Wrong?</title>
	<meta http-equiv="Content-Type" content="text/html; charset=iso-8859-1" />
	<meta name="description" content="Is it wrong that grown men should want to dress up in womans frocks and play a Stoolball game every year? I&#8217;ll let you decide, but these photos might offend the light hearted amongst you&#8230;" />
...
<div class="jounal-navigator">
	...
	<a href="http://www.whatisnext.co.uk/journal/2006/06/microsoft_net_frameworks.php" class="previous-entry">Microsoft .Net Frameworks</a>
	

	<a href="http://www.whatisnext.co.uk/journal/" class="journal-index">Journal Front Page</a>
	
	
	<a href="http://www.whatisnext.co.uk/journal/2006/08/leopard.php" class="next-entry">Leopard</a>
	
</div>    

		<div id="entry-589" class="entry">
					
			<h1>Is it Wrong?</h1>
					
			<div class="entry-body">
				<p>Is it wrong that grown men should want to dress up in womans frocks and play a Stoolball game every year?</p>

<p>I&#8217;ll let you decide, but these <a href="http://www.flickr.com/photos/whatisnext/tags/stoolball/">photos</a> might offend the light hearted amongst you</p>
			</div>
...
<div id="comment-wrapper" class="section-wrapper">
	<div id="comments" class="section">
			...
			<form method="post" action="http://www.whatisnext.co.uk/cgi-bin/mt/mt-comments.cgi" name="comments_form" onsubmit="if (this.bakecookie.checked) rememberMe(this)">
				...
				<input type="hidden" name="entry_id" value="589" />
				...
				<div class="comments-open" id="comments-open">
					...
					<div class="comments-open-content">
						...
						<!--
							writeTypeKeyGreeting(commenter_name, 589);
						//-->
						</script>
