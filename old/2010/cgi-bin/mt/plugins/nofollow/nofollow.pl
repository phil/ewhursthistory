# $Id: nofollow.pl 16542 2005-08-23 04:21:59Z jallen $
...
eval {
    ...
    $plugin = MT::Plugin->new({
        name => 'Nofollow',
        description => q{Adds a 'nofollow' relationship to comment and TrackBack hyperlinks to reduce spam.},
...
sub template {
    ...
    <div class="setting">
    <div class="label">
    <label for="follow_auth_links">Restrict:</label>
    </div>
    <div class="field">
    ...
    Don't add nofollow to links in comments by authenticated commenters</p>
    </div> 
    </div>
EOT
}
