...
#
# $Id: mt-db2sql.cgi 17282 2005-09-08 21:44:14Z bchoate $
...
# note, the non-integer id column of the MT::Session table isn't
# upgrading right, so that is omitted from this list.
my @CLASSES = qw( MT::Author MT::Blog MT::Category MT::Comment
                  ...
                  MT::Entry MT::TBPing MT::PluginData MT::Config );
