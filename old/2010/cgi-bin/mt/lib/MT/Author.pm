...
#
# $Id: Author.pm 15918 2005-08-09 17:11:01Z ezra $
...
sub set_commenter_perm {
    my $this = shift;
    my ($blog_id, $action) = @_;
    return $this->error("Can't approve/ban non-COMMENTER author")
    ...
    $perm->save()
        or return $this->error("The approval could not be committed: " . $perm->errstr);

#     # We no longer auto-publish comments when changing commenter's status
#     if ($was_pending) {
# 	require MT::Comment;
