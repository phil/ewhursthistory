...
#
# $Id: Object.pm 15432 2005-07-29 20:41:11Z bchoate $
...
sub install_properties {
    ...
    @cols = grep { defined $props->{column_defs}{$_} } @cols if exists $props->{column_defs};
...
sub properties {
    no strict 'refs';
    ref($_[0]) ? ${ref($_[0]).'::__properties'} : ${"$_[0]::__properties"};
}
