...
#
# $Id: ConfigMgr.pm 16293 2005-08-17 02:37:11Z bchoate $
...
sub init {
    ...
    $mgr->define([
        ...
        ['NoLocking', { Default => 0 }],
        ['NoHTMLEntities', { Default => 0 }],
        ['NoCDATA', { Default => 0 }],
        ['NoPlacementCache', { Default => 0 }],
        ['NoPublishMeansDraft', { Default => 0 }],
        ['IgnoreISOTimezones', { Default => 0 }],
        ['PingTimeout', { Default => 15 }],
        ['PingInterface'],
        ['PingProxy'],
        ['PingNoProxy', { Default => 'localhost, 127.0.0.1' }],
    ...
    ## into default config.
        ...
        ['LaunchBackgroundTasks', { Default => 1 }],
        ['TypeKeyVersion', { Default => 1 }],
        ...
        ['HelpURL', {Default => 'http://www.sixapart.com/movabletype/docs/' . MT->version_number . '/'}],
