...
#
# $Id: Blog.pm 16225 2005-08-16 01:06:26Z ezra $
...
sub email_attn_reqd_comments {
    return $_[0]->email_new_comments == 1 || $_[0]->email_new_comments == 2;
}
...
sub email_attn_reqd_pings {
    return $_[0]->email_new_pings == 1 || $_[0]->email_new_pings == 2;
}
...
sub remove {
    ...
    my @classes = qw( MT::Permission MT::Entry MT::Template
                      MT::Category MT::Notification MT::Log MT::PluginData );
    my $blog_id = $blog->id;
