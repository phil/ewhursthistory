				...
				<div class="general-column">
					...
					<table>
						<tr>
							...
							<td colspan="2"><span><input type="text" id="site_display" name="siteDisplay" value="<?php echo $Mint->cfg['siteDisplay'];?>" /></span></td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td colspan="2"><span><select name="offset" id="offset"><?php echo $Mint->generateOffsetOptions(); ?></select></span></td>
						</tr>
						<tr>
					...
					<table>
						<tr>
							...
							<td><span><input type="text" id="email" name="email" value="<?php echo $Mint->cfg['email'];?>" /></span></td>
						</tr>
						<tr>
							<th scope="row">Password</th>
							<td><span><input type="password" id="password" name="password" value="<?php echo $Mint->cfg['password'];?>" /></span></td>
						</tr>
						<tr>
							<td></td>
