...
username, password and database (name) then save and close. (Please contact your 
host if you are unsure of the correct values.)
...
page handy. NOTE: The login you create during installation is not related to 
your Mint Account Center login.
...
SURE TO MAKE A BACKUP OF YOUR DATA BEFORE PROCEEDING. PLEASE SEE THIS THREAD IF
...
before it and features a new Pepper API for developers. As a result you may want 
to check for updates to your favorite Pepper before updating as Pepper written 
for older versions will no longer work. To ensure that your Pepper data persists
through the update be sure to add the updated Pepper to the /pepper/ directory
BEFORE running the update.
--------------------------------------------------------------------------------

1. Remove/comment out the Mint JavaScript include from your site. (If you're 
...
username, password and database name, then save and close. (These are the same
values from previous versions of Mint that lived in /lib/configuration.php)
...
6. Restore/uncomment the Mint JavaScript include on your site. The path should 
be updated from /mint/mint.js.php to http://www.yourdomain.com/mint/?js
